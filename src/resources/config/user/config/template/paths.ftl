<paths>
<#assign module='${wizard.module.id}'>
<#list wizard.tables as table>
	...
	<path id="${table}">
		...
		<type>java</type>
		<xpath></xpath>
		<source>/template/javabean.ftl</source>
	...
	<path id="${table}">
		...
		<type>java</type>
		<xpath></xpath>
		<source>/template/action.ftl</source>
	...
	<path id="${table}">
		...
		<type>java</type>
		<xpath></xpath>
		<source>/template/service.ftl</source>
	...
	<path id="${table}">
		...
		<#if module == 'jsp'>
		<path id="${table}">
		<name>${table} add jsp</name>
		<encoding>UTF-8</encoding>
		<type>java</type>
		<xpath></xpath>
		<source>/template/addJsp.ftl</source>
		<target>${wizard.container}/${wizard.pack?replace(".", "/")}/mapper/${sname}Edit.jsp</target>
		<description>JAVA service</description>
		</path>
		<path id="${table}">
		...
		<type>java</type>
		<xpath></xpath>
		<source>/template/listJsp.ftl</source>
		<target>${wizard.container}/${wizard.pack?replace(".", "/")}/mapper/${sname}List.jsp</target>
		<description>JAVA service</description>
		</path>
		</#if>
 </#list>
		...
		<type>xml</type>
		<xpath>sqlMap</xpath>
		<source>/template/list-config.ftl</source>
		<target>${wizard.container}/${wizard.pack?replace(".", "/")}/mapper/listMapper.xml</target>
		<description>ibatis config</description>
		</path>
		</#if>
</paths>