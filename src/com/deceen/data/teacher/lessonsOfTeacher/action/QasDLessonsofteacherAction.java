package	com.deceen.data.teacher.lessonsOfTeacher.action;
...
* @date2017-11-23 12:34:30
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDLessonsofteacherAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDLessonsofteacherAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDLessonsofteacherAction.class);

	private  QasDLessonsofteacherService service;
	
	private QasDLessonsofteacher bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDLessonsofteacher dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDLessonsofteacherService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDLessonsofteacherService service) {
		this.service = service;
	}

	public QasDLessonsofteacher getBean() {
		return bean;
	}

	public void setBean(QasDLessonsofteacher bean) {
		this.bean = bean;
	}
