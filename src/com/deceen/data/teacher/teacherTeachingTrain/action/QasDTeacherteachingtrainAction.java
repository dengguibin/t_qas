package	com.deceen.data.teacher.teacherTeachingTrain.action;
...
* @date2017-11-23 12:29:49
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTeacherteachingtrainAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeacherteachingtrainAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTeacherteachingtrainAction.class);

	private  QasDTeacherteachingtrainService service;
	
	private QasDTeacherteachingtrain bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDTeacherteachingtrain();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTeacherteachingtrain dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDTeacherteachingtrainService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeacherteachingtrainService service) {
		this.service = service;
	}

	public QasDTeacherteachingtrain getBean() {
		return bean;
	}

	public void setBean(QasDTeacherteachingtrain bean) {
		this.bean = bean;
	}
