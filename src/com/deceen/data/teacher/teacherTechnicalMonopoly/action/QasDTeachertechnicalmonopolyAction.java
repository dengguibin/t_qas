package	com.deceen.data.teacher.teacherTechnicalMonopoly.action;
...
* @date2017-11-23 12:32:42
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTeachertechnicalmonopolyAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeachertechnicalmonopolyAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTeachertechnicalmonopolyAction.class);

	private  QasDTeachertechnicalmonopolyService service;
	
	private QasDTeachertechnicalmonopoly bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDTeachertechnicalmonopoly();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTeachertechnicalmonopoly dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDTeachertechnicalmonopolyService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeachertechnicalmonopolyService service) {
		this.service = service;
	}

	public QasDTeachertechnicalmonopoly getBean() {
		return bean;
	}

	public void setBean(QasDTeachertechnicalmonopoly bean) {
		this.bean = bean;
	}
