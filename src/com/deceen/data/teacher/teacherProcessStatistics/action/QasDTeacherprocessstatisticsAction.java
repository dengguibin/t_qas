package com.deceen.data.teacher.teacherProcessStatistics.action;
 ...
 * @date2017-11-23 12:35:03
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDTeacherprocessstatisticsAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeacherprocessstatisticsAction extends BaseActionSupport {

	private static final Logger log = Logger
			.getLogger(QasDTeacherprocessstatisticsAction.class);

	private QasDTeacherprocessstatisticsService service;

	private QasDTeacherprocessstatistics bean;
	...
	public String queryList() throws Exception {
		if (bean == null) {
			bean = new QasDTeacherprocessstatistics();
		}
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDTeacherprocessstatistics dsBean = service.select(bean
						.getId());
				if (dsBean != null) {
					if (user != null) {
	...
	public String remove() throws Exception {
		...
		if (bean != null && bean.getId() != null) {
			...
			// //是否有对应的数据存在
			// Integer.valueOf(((Map)service.get2Object("查询数据的行数",
	...
	public QasDTeacherprocessstatisticsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeacherprocessstatisticsService service) {
		this.service = service;
	}

	public QasDTeacherprocessstatistics getBean() {
		return bean;
	}

	public void setBean(QasDTeacherprocessstatistics bean) {
		this.bean = bean;
	}
