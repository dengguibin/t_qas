package	com.deceen.data.teacher.teacherAward.action;
...
* @date2017-11-23 12:32:07
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTeacherawardAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeacherawardAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTeacherawardAction.class);

	private  QasDTeacherawardService service;
	
	private QasDTeacheraward bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTeacheraward dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDTeacherawardService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeacherawardService service) {
		this.service = service;
	}

	public QasDTeacheraward getBean() {
		return bean;
	}

	public void setBean(QasDTeacheraward bean) {
		this.bean = bean;
	}
