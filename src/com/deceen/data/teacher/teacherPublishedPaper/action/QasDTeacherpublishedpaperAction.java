package com.deceen.data.teacher.teacherPublishedPaper.action;
 ...
 * @date2017-11-23 12:33:51
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDTeacherpublishedpaperAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeacherpublishedpaperAction extends BaseActionSupport {

	private static final Logger log = Logger
			.getLogger(QasDTeacherpublishedpaperAction.class);

	private QasDTeacherpublishedpaperService service;

	private QasDTeacherpublishedpaper bean;
	...
	public String queryList() throws Exception {
		if (bean == null) {
			bean = new QasDTeacherpublishedpaper();
		}
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDTeacherpublishedpaper dsBean = service.select(bean.getId());
				if (dsBean != null) {
					if (user != null) {
	...
	public QasDTeacherpublishedpaperService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeacherpublishedpaperService service) {
		this.service = service;
	}

	public QasDTeacherpublishedpaper getBean() {
		return bean;
	}

	public void setBean(QasDTeacherpublishedpaper bean) {
		this.bean = bean;
	}
