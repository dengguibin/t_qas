package	com.deceen.data.teacher.teacherPartTimeWork.action;
...
* @date2017-11-23 12:31:22
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTeacherparttimeworkAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeacherparttimeworkAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTeacherparttimeworkAction.class);

	private  QasDTeacherparttimeworkService service;
	
	private QasDTeacherparttimework bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDTeacherparttimework();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTeacherparttimework dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDTeacherparttimeworkService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeacherparttimeworkService service) {
		this.service = service;
	}

	public QasDTeacherparttimework getBean() {
		return bean;
	}

	public void setBean(QasDTeacherparttimework bean) {
		this.bean = bean;
	}
