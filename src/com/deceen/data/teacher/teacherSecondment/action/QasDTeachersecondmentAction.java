package	com.deceen.data.teacher.teacherSecondment.action;
...
* @date2017-11-23 14:56:55
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTeachersecondmentAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeachersecondmentAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTeachersecondmentAction.class);

	private  QasDTeachersecondmentService service;
	
	private QasDTeachersecondment bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDTeachersecondment();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTeachersecondment dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDTeachersecondmentService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeachersecondmentService service) {
		this.service = service;
	}

	public QasDTeachersecondment getBean() {
		return bean;
	}

	public void setBean(QasDTeachersecondment bean) {
		this.bean = bean;
	}
