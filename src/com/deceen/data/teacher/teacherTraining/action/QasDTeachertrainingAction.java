package	com.deceen.data.teacher.teacherTraining.action;
...
* @date2017-11-23 12:30:17
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTeachertrainingAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeachertrainingAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTeachertrainingAction.class);

	private  QasDTeachertrainingService service;
	
	private QasDTeachertraining bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTeachertraining dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDTeachertrainingService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeachertrainingService service) {
		this.service = service;
	}

	public QasDTeachertraining getBean() {
		return bean;
	}

	public void setBean(QasDTeachertraining bean) {
		this.bean = bean;
	}
