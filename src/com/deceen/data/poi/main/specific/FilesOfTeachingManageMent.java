...
public class FilesOfTeachingManageMent extends Common{

	public String BuildSql(List<String> list) {
		StringBuffer sb = new StringBuffer("INSERT INTO QAS_D_FILESOFTEACHINGMANAGEMENT   ( ");
		sb.append(" ID,NAME,PUBLISHEDDATE,PUBLISHEDDEPARTMENT,MODIFY,MODIFIDATE,RESPONSIBLEDEPARTMENT,STATUS,CREATEDBY,CREATEDTIME,UPDATEDBY,UPDATEDTIME,TENANTID,STORAGETIME)");
		sb.append(" VALUES (");
		/**
