...
public class StudentAward extends Common{

	public String BuildSql(List<String> list) {
		StringBuffer sb = new StringBuffer("INSERT INTO QAS_D_STUDENTAWARD   ( ");
		sb.append(" ID,PROJNAME,PROJTYPE,GRADE,AWARDDATE,STUDENTLIST,TUTORS,STATUS,CREATEDBY,CREATEDTIME,UPDATEDBY,UPDATEDTIME,TENANTID,STORAGETIME)");
		sb.append(" VALUES (");
		/**
