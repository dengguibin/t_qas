...
public class MajorLeader extends Common{

	public String BuildSql(List<String> list) {
		StringBuffer sb = new StringBuffer("INSERT INTO QAS_D_MAJORLEADER   ( ");
		sb.append("ID,MAJORID,EMPLOYEEID,HEADYEAR,PROJECTNAME,PROJECTSUMMARY,PROJECTAWARD,AWARDDATE,COOPRATION,ISMAJORLEADING,ISMAJORLEADER,ISMAJORHEAD,STATUS,CREATEDBY,CREATEDTIME,UPDATEDBY,UPDATEDTIME,TENANTID,STORAGETIME)");
		sb.append("VALUES (");
		/**
