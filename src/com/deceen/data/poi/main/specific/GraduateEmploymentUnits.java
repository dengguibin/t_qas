...
public class GraduateEmploymentUnits extends Common{

	public String BuildSql(List<String> list) {
		StringBuffer sb = new StringBuffer("INSERT INTO QAS_D_GRADUATEEMPLOYMENTUNITS   ( ");
		sb.append("ID,MAINEMPLOYMENTUNIT,ISEMPLOYERSURVEY,CONTACTNAME,CONTACTDUTY,CONTACTPHONE,CONTACTEMAIL,STATUS,CREATEDBY,CREATEDTIME,UPDATEDBY,UPDATEDTIME,TENANTID,STORAGETIME)");
		sb.append(" VALUES (");
		/**
