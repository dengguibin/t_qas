...
public class Empolyee extends Common{

	public String BuildSql(List<String> list) {
		StringBuffer sb = new StringBuffer("INSERT INTO QAS_D_EMPOLYEE   ( ");
		sb.append("ID,DEPARTMENTID,EMPLOYEECODE,NAME,NATION,DUTY,TITLE,QUALIFICATION,ACADEMICDEGREE,SEX,BIRTHDAY,MAJORDEEP,HIGHMAJORNAME,GRANTCOMPANY,RECEIVEDDATE,SPECIALAREA,SPECIALTY,ISTEACHERDEGREE,WORKYEAR,WORKINCURRENTYEAR,QUALIFICATIONLEVEL,QUALIFICATIONNAME,QUALIFICATIONUNIT,QUALIFICATIONRECEIVEDATE,TEACHERQUALIFICATIONUNIT,TEACHERQUALIFICATIONRECEIVEDATE,ISPROFESSIONALTEACHER,ISCORETEACHER,DOUBLEQUALIFIEDTEACHER,FAMOUSTEACHER,STATUS,CREATEDBY,CREATEDTIME,UPDATEDBY,UPDATEDTIME,TENANTID,STORAGETIME)");
		sb.append(" VALUES (");
		/**
 ...
 */
		...
		String s1 =  list.get(0), s2 = list.get(1), s3 = list.get(2), s4 = list.get(5), s5 = list.get(15),s6 = list.get(19),s7 = list.get(6),s8 = list.get(7),s9 = list.get(3),s10 = list.get(4),s11 = list.get(14),s12 = list.get(15),
				s13 =  list.get(16), s14 = list.get(17), s15 = list.get(8), s16 = list.get(9), s17 = list.get(10),s18 = list.get(12),s19 = list.get(13),s20 = list.get(18),s21 = list.get(19),s22 = list.get(20),
						s23 =  list.get(21), s24 = list.get(10),s25 = list.get(11), s26 = list.get(22), s27 = list.get(23), s28 = list.get(24),s29 = list.get(25);
		String s =s1+"-"+s2+"-"+s3;
		...
		sb.append("'"+s15+"',");
		sb.append("'"+s16+"',");
		sb.append("'"+(StringUtils.isEmpty(s17)?"无":"有")+"',");
		sb.append("'"+s18+"',");
		sb.append("'"+s19+"',");
		sb.append("'"+s20+"',");
		sb.append("'"+s21+"',");
