...
public class Empolyee1 extends Common{

	public String BuildSql(List<String> list) {
		StringBuffer sb = new StringBuffer("INSERT INTO QAS_D_EMPOLYEE   ( ");
		sb.append("ID,EMPLOYEECODE,NAME,NATION,DUTY,QUALIFICATION,ACADEMICDEGREE,SEX,BIRTHDAY,MAJORDEEP,HIGHMAJORNAME,GRANTCOMPANY,RECEIVEDDATE,SPECIALAREA,SPECIALTY,ISTEACHERDEGREE,WORKYEAR,WORKINCURRENTYEAR,TEACHERQUALIFICATIONUNIT,TEACHERQUALIFICATIONRECEIVEDATE,ISCORETEACHER,DOUBLEQUALIFIEDTEACHER,FAMOUSTEACHER,STATUS,CREATEDBY,CREATEDTIME,UPDATEDBY,UPDATEDTIME,TENANTID,STORAGETIME)");
		sb.append(" VALUES (");
		/**
 ...
 */
		...
		String s1 =  list.get(1), s2 = list.get(2), s3 = list.get(5), s4 = list.get(18), s5 = list.get(6),s6 = list.get(7),s7 = list.get(3),s8 = list.get(4),s9 = list.get(12),s10 = list.get(13),
				s11 =  list.get(14), s12 = list.get(15), s13 = list.get(8), s14 = list.get(9), s15 = list.get(16),s16 = list.get(10),s17 = list.get(11),s18 = list.get(16),s19 = list.get(17),s20 = list.get(19),
						s21 =  list.get(20), s22 = list.get(21);
		String s =s1+"-"+s2+"-"+s3;
		...
		sb.append("'"+s13+"',");
		sb.append("'"+s14+"',");
		sb.append("'"+(StringUtils.isEmpty(s15)?"无":"有")+"',");
		sb.append("'"+s16+"',");
		sb.append("'"+s17+"',");
		sb.append("'"+s18+"',");
		sb.append("'"+s19+"',");
