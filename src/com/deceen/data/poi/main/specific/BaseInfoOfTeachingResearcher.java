...
public class BaseInfoOfTeachingResearcher extends Common{

	public String BuildSql(List<String> list) {
		StringBuffer sb = new StringBuffer("INSERT INTO QAS_D_BASEINFOOFTEACHINGRESEARCHER   ( ");
		sb.append(" ID,EMPLOYEEID,SPECIALAREA,RESEARCHCOUNT,RESEARCHLEVEL,RESEARCHCOOPERATION,STATUS,CREATEDBY,CREATEDTIME,UPDATEDBY,UPDATEDTIME,TENANTID,STORAGETIME)");
		sb.append(" VALUES (");
		/**
...
*/
		...
		String s1 =  list.get(0), s2 = list.get(8), s3 = list.get(23),s4 = list.get(24),s5 = list.get(25);
