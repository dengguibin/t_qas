package com.deceen.data.fund.fundIncomeStatistics.action;
 ...
 * @date2017-11-23 12:15:54
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDFundincomestatisticsAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial", "unused" })
public class QasDFundincomestatisticsAction extends BaseActionSupport {

	private static final Logger log = Logger
			.getLogger(QasDFundincomestatisticsAction.class);

	private QasDFundincomestatisticsService service;

	private QasDFundincomestatistics bean;
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDFundincomestatistics dsBean = service.select(bean.getId());
				if (dsBean != null) {
					if (user != null) {
	...
	public QasDFundincomestatisticsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDFundincomestatisticsService service) {
		this.service = service;
	}

	public QasDFundincomestatistics getBean() {
		return bean;
	}

	public void setBean(QasDFundincomestatistics bean) {
		this.bean = bean;
	}
