package com.deceen.data.teaching.teachingManagement.action;
 ...
 * @date2017-11-24 12:12:21
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDTeachingmanagementAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeachingmanagementAction extends BaseActionSupport {

	private static final Logger log = Logger
			.getLogger(QasDTeachingmanagementAction.class);

	private QasDTeachingmanagementService service;

	private QasDTeachingmanagement bean;
	...
	public String queryList() throws Exception {
		if (bean == null) {
			bean = new QasDTeachingmanagement();
		}
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDTeachingmanagement dsBean = service.select(bean.getId());
				if (dsBean != null) {
	...
	public QasDTeachingmanagementService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeachingmanagementService service) {
		this.service = service;
	}

	public QasDTeachingmanagement getBean() {
		return bean;
	}

	public void setBean(QasDTeachingmanagement bean) {
		this.bean = bean;
	}
