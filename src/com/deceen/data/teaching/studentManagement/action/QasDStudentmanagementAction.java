package com.deceen.data.teaching.studentManagement.action;
 ...
 * @date2017-11-24 12:14:24
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDStudentmanagementAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDStudentmanagementAction extends BaseActionSupport {

	private static final Logger log = Logger
			.getLogger(QasDStudentmanagementAction.class);

	private QasDStudentmanagementService service;

	private QasDStudentmanagement bean;
	...
	public String queryList() throws Exception {
		if (bean == null) {
			bean = new QasDStudentmanagement();
		}
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDStudentmanagement dsBean = service.select(bean.getId());
				if (dsBean != null) {
	...
	public QasDStudentmanagementService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDStudentmanagementService service) {
		this.service = service;
	}

	public QasDStudentmanagement getBean() {
		return bean;
	}

	public void setBean(QasDStudentmanagement bean) {
		this.bean = bean;
	}
