package	com.deceen.data.teaching.filesOfTeachingManageMent.action;
...
* @date2017-11-24 12:13:39
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDFilesofteachingmanagementAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDFilesofteachingmanagementAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDFilesofteachingmanagementAction.class);

	private  QasDFilesofteachingmanagementService service;
	
	private QasDFilesofteachingmanagement bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDFilesofteachingmanagement();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDFilesofteachingmanagement dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDFilesofteachingmanagementService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDFilesofteachingmanagementService service) {
		this.service = service;
	}

	public QasDFilesofteachingmanagement getBean() {
		return bean;
	}

	public void setBean(QasDFilesofteachingmanagement bean) {
		this.bean = bean;
	}
