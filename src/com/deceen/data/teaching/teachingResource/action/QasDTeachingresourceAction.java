package	com.deceen.data.teaching.teachingResource.action;
...
* @date2017-11-24 12:23:34
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTeachingresourceAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeachingresourceAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTeachingresourceAction.class);

	private  QasDTeachingresourceService service;
	
	private QasDTeachingresource bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTeachingresource dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDTeachingresourceService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeachingresourceService service) {
		this.service = service;
	}

	public QasDTeachingresource getBean() {
		return bean;
	}

	public void setBean(QasDTeachingresource bean) {
		this.bean = bean;
	}
