package com.deceen.data.teaching.teachingEvaluation.action;
 ...
 * @date2017-11-24 12:17:59
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDTeachingevaluationAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeachingevaluationAction extends BaseActionSupport {

	private static final Logger log = Logger
			.getLogger(QasDTeachingevaluationAction.class);

	private QasDTeachingevaluationService service;

	private QasDTeachingevaluation bean;
	...
	public String queryList() throws Exception {
		if (bean == null) {
			bean = new QasDTeachingevaluation();
		}
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDTeachingevaluation dsBean = service.select(bean.getId());
				if (dsBean != null) {
	...
	public QasDTeachingevaluationService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeachingevaluationService service) {
		this.service = service;
	}

	public QasDTeachingevaluation getBean() {
		return bean;
	}

	public void setBean(QasDTeachingevaluation bean) {
		this.bean = bean;
	}
