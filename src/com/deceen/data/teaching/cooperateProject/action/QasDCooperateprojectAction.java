package	com.deceen.data.teaching.cooperateProject.action;
...
* @date2017-11-24 12:25:18
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDCooperateprojectAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDCooperateprojectAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDCooperateprojectAction.class);

	private  QasDCooperateprojectService service;
	
	private QasDCooperateproject bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDCooperateproject dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDCooperateprojectService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDCooperateprojectService service) {
		this.service = service;
	}

	public QasDCooperateproject getBean() {
		return bean;
	}

	public void setBean(QasDCooperateproject bean) {
		this.bean = bean;
	}
