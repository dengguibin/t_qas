package	com.deceen.data.teaching.baseInfoOfEmploymentGuidance.action;
...
* @date2017-11-24 12:14:53
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDBaseinfoofemploymentguidanceAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDBaseinfoofemploymentguidanceAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDBaseinfoofemploymentguidanceAction.class);

	private  QasDBaseinfoofemploymentguidanceService service;
	
	private QasDBaseinfoofemploymentguidance bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDBaseinfoofemploymentguidance();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDBaseinfoofemploymentguidance dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDBaseinfoofemploymentguidanceService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDBaseinfoofemploymentguidanceService service) {
		this.service = service;
	}

	public QasDBaseinfoofemploymentguidance getBean() {
		return bean;
	}

	public void setBean(QasDBaseinfoofemploymentguidance bean) {
		this.bean = bean;
	}
