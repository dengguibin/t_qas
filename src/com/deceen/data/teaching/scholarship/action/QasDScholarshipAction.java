package	com.deceen.data.teaching.scholarship.action;
...
* @date2017-11-24 12:19:49
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDScholarshipAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDScholarshipAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDScholarshipAction.class);

	private  QasDScholarshipService service;
	
	private QasDScholarship bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDScholarship dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDScholarshipService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDScholarshipService service) {
		this.service = service;
	}

	public QasDScholarship getBean() {
		return bean;
	}

	public void setBean(QasDScholarship bean) {
		this.bean = bean;
	}
