package	com.deceen.data.teaching.innovativeTrainProj.action;
...
* @date2017-11-24 12:24:09
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDInnovativetrainprojAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDInnovativetrainprojAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDInnovativetrainprojAction.class);

	private  QasDInnovativetrainprojService service;
	
	private QasDInnovativetrainproj bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDInnovativetrainproj();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDInnovativetrainproj dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDInnovativetrainprojService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDInnovativetrainprojService service) {
		this.service = service;
	}

	public QasDInnovativetrainproj getBean() {
		return bean;
	}

	public void setBean(QasDInnovativetrainproj bean) {
		this.bean = bean;
	}
