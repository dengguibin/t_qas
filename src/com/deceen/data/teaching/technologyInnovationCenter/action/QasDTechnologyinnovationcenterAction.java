package	com.deceen.data.teaching.technologyInnovationCenter.action;
...
* @date2017-11-24 12:22:05
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTechnologyinnovationcenterAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTechnologyinnovationcenterAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTechnologyinnovationcenterAction.class);

	private  QasDTechnologyinnovationcenterService service;
	
	private QasDTechnologyinnovationcenter bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDTechnologyinnovationcenter();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTechnologyinnovationcenter dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDTechnologyinnovationcenterService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTechnologyinnovationcenterService service) {
		this.service = service;
	}

	public QasDTechnologyinnovationcenter getBean() {
		return bean;
	}

	public void setBean(QasDTechnologyinnovationcenter bean) {
		this.bean = bean;
	}
