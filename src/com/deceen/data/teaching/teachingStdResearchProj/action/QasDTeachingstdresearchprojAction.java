package	com.deceen.data.teaching.teachingStdResearchProj.action;
...
* @date2017-11-24 12:21:03
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTeachingstdresearchprojAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTeachingstdresearchprojAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTeachingstdresearchprojAction.class);

	private  QasDTeachingstdresearchprojService service;
	
	private QasDTeachingstdresearchproj bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDTeachingstdresearchproj();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTeachingstdresearchproj dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDTeachingstdresearchprojService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTeachingstdresearchprojService service) {
		this.service = service;
	}

	public QasDTeachingstdresearchproj getBean() {
		return bean;
	}

	public void setBean(QasDTeachingstdresearchproj bean) {
		this.bean = bean;
	}
