package com.deceen.data.teaching.majorSysInnovation.action;
 ...
 * @date2017-11-24 12:20:23
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDMajorsysinnovationAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDMajorsysinnovationAction extends BaseActionSupport {

	private static final Logger log = Logger
			.getLogger(QasDMajorsysinnovationAction.class);

	private QasDMajorsysinnovationService service;

	private QasDMajorsysinnovation bean;
	...
	public String queryList() throws Exception {
		if (bean == null) {
			bean = new QasDMajorsysinnovation();
		}
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDMajorsysinnovation dsBean = service.select(bean.getId());
				if (dsBean != null) {
	...
	public QasDMajorsysinnovationService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDMajorsysinnovationService service) {
		this.service = service;
	}

	public QasDMajorsysinnovation getBean() {
		return bean;
	}

	public void setBean(QasDMajorsysinnovation bean) {
		this.bean = bean;
	}
