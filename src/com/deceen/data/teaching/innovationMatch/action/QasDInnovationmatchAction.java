package	com.deceen.data.teaching.innovationMatch.action;
...
* @date2017-11-24 12:24:43
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDInnovationmatchAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDInnovationmatchAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDInnovationmatchAction.class);

	private  QasDInnovationmatchService service;
	
	private QasDInnovationmatch bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDInnovationmatch dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDInnovationmatchService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDInnovationmatchService service) {
		this.service = service;
	}

	public QasDInnovationmatch getBean() {
		return bean;
	}

	public void setBean(QasDInnovationmatch bean) {
		this.bean = bean;
	}
