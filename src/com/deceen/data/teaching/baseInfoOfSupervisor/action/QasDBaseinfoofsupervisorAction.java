package	com.deceen.data.teaching.baseInfoOfSupervisor.action;
...
* @date2017-11-24 12:15:23
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDBaseinfoofsupervisorAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDBaseinfoofsupervisorAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDBaseinfoofsupervisorAction.class);

	private  QasDBaseinfoofsupervisorService service;
	
	private QasDBaseinfoofsupervisor bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDBaseinfoofsupervisor();
		}
...
IUser user = getLoginUser();
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDBaseinfoofsupervisor dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDBaseinfoofsupervisorService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDBaseinfoofsupervisorService service) {
		this.service = service;
	}

	public QasDBaseinfoofsupervisor getBean() {
		return bean;
	}

	public void setBean(QasDBaseinfoofsupervisor bean) {
		this.bean = bean;
	}
