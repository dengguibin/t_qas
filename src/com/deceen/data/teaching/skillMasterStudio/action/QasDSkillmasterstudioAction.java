package	com.deceen.data.teaching.skillMasterStudio.action;
...
* @date2017-11-24 12:22:47
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDSkillmasterstudioAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDSkillmasterstudioAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDSkillmasterstudioAction.class);

	private  QasDSkillmasterstudioService service;
	
	private QasDSkillmasterstudio bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDSkillmasterstudio();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDSkillmasterstudio dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDSkillmasterstudioService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDSkillmasterstudioService service) {
		this.service = service;
	}

	public QasDSkillmasterstudio getBean() {
		return bean;
	}

	public void setBean(QasDSkillmasterstudio bean) {
		this.bean = bean;
	}
