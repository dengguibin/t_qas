package	com.deceen.data.teaching.baseInfoOfTeachingResearcher.action;
...
* @date2017-11-24 12:15:52
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDBaseinfoofteachingresearcherAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDBaseinfoofteachingresearcherAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDBaseinfoofteachingresearcherAction.class);

	private  QasDBaseinfoofteachingresearcherService service;
	
	private QasDBaseinfoofteachingresearcher bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDBaseinfoofteachingresearcher();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDBaseinfoofteachingresearcher dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDBaseinfoofteachingresearcherService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDBaseinfoofteachingresearcherService service) {
		this.service = service;
	}

	public QasDBaseinfoofteachingresearcher getBean() {
		return bean;
	}

	public void setBean(QasDBaseinfoofteachingresearcher bean) {
		this.bean = bean;
	}
