package com.deceen.data.teaching.virtualSimulationCenter.action;
 ...
 * @date2017-11-24 12:21:32
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDVirtualsimulationcenterAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDVirtualsimulationcenterAction extends BaseActionSupport {

	private static final Logger log = Logger
			.getLogger(QasDVirtualsimulationcenterAction.class);

	private QasDVirtualsimulationcenterService service;

	private QasDVirtualsimulationcenter bean;
	...
	public String queryList() throws Exception {
		if (bean == null) {
			bean = new QasDVirtualsimulationcenter();
		}
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDVirtualsimulationcenter dsBean = service.select(bean
						.getId());
				if (dsBean != null) {
	...
	public QasDVirtualsimulationcenterService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDVirtualsimulationcenterService service) {
		this.service = service;
	}

	public QasDVirtualsimulationcenter getBean() {
		return bean;
	}

	public void setBean(QasDVirtualsimulationcenter bean) {
		this.bean = bean;
	}
