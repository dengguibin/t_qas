package	com.deceen.data.school.fixedAssets.action;
...
* @date2017-11-22 17:47:30
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDFixedassetsAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDFixedassetsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDFixedassetsAction.class);

	private  QasDFixedassetsService service;
	
	private QasDFixedassets bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDFixedassets dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDFixedassetsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDFixedassetsService service) {
		this.service = service;
	}

	public QasDFixedassets getBean() {
		return bean;
	}

	public void setBean(QasDFixedassets bean) {
		this.bean = bean;
	}
