package	com.deceen.data.school.trainingBaseOutOfCampusStatistics.action;
...
* @date2017-11-22 17:58:43
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTrainingbaseoutofcampusstatisticsAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTrainingbaseoutofcampusstatisticsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTrainingbaseoutofcampusstatisticsAction.class);

	private  QasDTrainingbaseoutofcampusstatisticsService service;
	
	private QasDTrainingbaseoutofcampusstatistics bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTrainingbaseoutofcampusstatistics dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDTrainingbaseoutofcampusstatisticsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTrainingbaseoutofcampusstatisticsService service) {
		this.service = service;
	}

	public QasDTrainingbaseoutofcampusstatistics getBean() {
		return bean;
	}

	public void setBean(QasDTrainingbaseoutofcampusstatistics bean) {
		this.bean = bean;
	}
