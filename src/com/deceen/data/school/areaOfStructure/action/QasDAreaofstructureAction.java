package	com.deceen.data.school.areaOfStructure.action;
...
* @date2017-11-22 17:44:17
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDAreaofstructureAction")	
@SuppressWarnings({ "rawtypes", "serial","unchecked" })
public class QasDAreaofstructureAction  extends BaseActionSupport{

	@SuppressWarnings("unused")
	private static final Logger log = Logger.getLogger(QasDAreaofstructureAction.class);

	private  QasDAreaofstructureService service;
	
	private QasDAreaofstructure bean;
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDAreaofstructure dsBean = service.select(bean.getId());
				if (dsBean != null) {
					if (user != null) {
...
//			}	
	...
	public QasDAreaofstructureService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDAreaofstructureService service) {
		this.service = service;
	}

	public QasDAreaofstructure getBean() {
		return bean;
	}

	public void setBean(QasDAreaofstructure bean) {
		this.bean = bean;
	}
