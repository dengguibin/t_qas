package	com.deceen.data.school.skillAppraisalOrg.action;
...
* @date2017-11-22 17:59:15
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDSkillappraisalorgAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDSkillappraisalorgAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDSkillappraisalorgAction.class);

	private  QasDSkillappraisalorgService service;
	
	private QasDSkillappraisalorg bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDSkillappraisalorg();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDSkillappraisalorg dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDSkillappraisalorgService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDSkillappraisalorgService service) {
		this.service = service;
	}

	public QasDSkillappraisalorg getBean() {
		return bean;
	}

	public void setBean(QasDSkillappraisalorg bean) {
		this.bean = bean;
	}
