package	com.deceen.data.school.practiceBaseInCampusStatistics.action;
...
* @date2017-11-22 17:52:24
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDPracticebaseincampusstatisticsAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDPracticebaseincampusstatisticsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDPracticebaseincampusstatisticsAction.class);

	private  QasDPracticebaseincampusstatisticsService service;
	
	private QasDPracticebaseincampusstatistics bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDPracticebaseincampusstatistics dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDPracticebaseincampusstatisticsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDPracticebaseincampusstatisticsService service) {
		this.service = service;
	}

	public QasDPracticebaseincampusstatistics getBean() {
		return bean;
	}

	public void setBean(QasDPracticebaseincampusstatistics bean) {
		this.bean = bean;
	}
