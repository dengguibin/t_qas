package	com.deceen.data.school.collegeInSchoolStudent.action;
...
* @date2017-11-22 17:42:22
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDCollegeinschoolstudentAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDCollegeinschoolstudentAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDCollegeinschoolstudentAction.class);

	private  QasDCollegeinschoolstudentService service;
	
	private QasDCollegeinschoolstudent bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDCollegeinschoolstudent dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDCollegeinschoolstudentService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDCollegeinschoolstudentService service) {
		this.service = service;
	}

	public QasDCollegeinschoolstudent getBean() {
		return bean;
	}

	public void setBean(QasDCollegeinschoolstudent bean) {
		this.bean = bean;
	}
