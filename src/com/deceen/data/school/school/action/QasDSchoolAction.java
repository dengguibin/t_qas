package com.deceen.data.school.school.action;
 ...
 * @date2017-11-22 17:18:45
 * @version V1.0
 */
@Scope("prototype")
@Component("qasDSchoolAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDSchoolAction extends BaseActionSupport {

	private static final Logger log = Logger.getLogger(QasDSchoolAction.class);

	private QasDSchoolService service;

	private QasDSchool bean;
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDSchool dsBean = service.select(bean.getId());
				if (dsBean != null) {
					if (user != null) {
	...
	public QasDSchoolService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDSchoolService service) {
		this.service = service;
	}

	public QasDSchool getBean() {
		return bean;
	}

	public void setBean(QasDSchool bean) {
		this.bean = bean;
	}
