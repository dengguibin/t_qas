package	com.deceen.data.school.shoolAward.action;
...
* @date2017-11-22 18:01:28
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDShoolawardAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDShoolawardAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDShoolawardAction.class);

	private  QasDShoolawardService service;
	
	private QasDShoolaward bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDShoolaward dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDShoolawardService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDShoolawardService service) {
		this.service = service;
	}

	public QasDShoolaward getBean() {
		return bean;
	}

	public void setBean(QasDShoolaward bean) {
		this.bean = bean;
	}
