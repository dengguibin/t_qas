package	com.deceen.data.school.rooms.action;
...
* @date2017-11-22 17:45:25
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDRoomsAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDRoomsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDRoomsAction.class);

	private  QasDRoomsService service;
	
	private QasDRooms bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDRooms dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDRoomsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDRoomsService service) {
		this.service = service;
	}

	public QasDRooms getBean() {
		return bean;
	}

	public void setBean(QasDRooms bean) {
		this.bean = bean;
	}
