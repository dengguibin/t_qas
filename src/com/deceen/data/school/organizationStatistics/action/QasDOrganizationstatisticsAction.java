package	com.deceen.data.school.organizationStatistics.action;
...
* @date2017-11-22 17:43:07
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDOrganizationstatisticsAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDOrganizationstatisticsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDOrganizationstatisticsAction.class);

	private  QasDOrganizationstatisticsService service;
	
	private QasDOrganizationstatistics bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDOrganizationstatistics dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDOrganizationstatisticsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDOrganizationstatisticsService service) {
		this.service = service;
	}

	public QasDOrganizationstatistics getBean() {
		return bean;
	}

	public void setBean(QasDOrganizationstatistics bean) {
		this.bean = bean;
	}
