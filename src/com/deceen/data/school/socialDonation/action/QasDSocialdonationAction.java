package	com.deceen.data.school.socialDonation.action;
...
* @date2017-11-22 18:00:58
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDSocialdonationAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDSocialdonationAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDSocialdonationAction.class);

	private  QasDSocialdonationService service;
	
	private QasDSocialdonation bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDSocialdonation dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDSocialdonationService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDSocialdonationService service) {
		this.service = service;
	}

	public QasDSocialdonation getBean() {
		return bean;
	}

	public void setBean(QasDSocialdonation bean) {
		this.bean = bean;
	}
