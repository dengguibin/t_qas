package	com.deceen.data.school.contacter.action;
...
* @date2017-11-22 17:30:20
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDSchoolcontacterAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDSchoolcontacterAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDSchoolcontacterAction.class);

	private  QasDSchoolcontacterService service;
	
	private QasDSchoolcontacter bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDSchoolcontacter dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDSchoolcontacterService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDSchoolcontacterService service) {
		this.service = service;
	}

	public QasDSchoolcontacter getBean() {
		return bean;
	}

	public void setBean(QasDSchoolcontacter bean) {
		this.bean = bean;
	}
