package	com.deceen.data.school.trainingBaseOutOfCampus.action;
...
* @date2017-11-22 17:58:05
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDTrainingbaseoutofcampusAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDTrainingbaseoutofcampusAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDTrainingbaseoutofcampusAction.class);

	private  QasDTrainingbaseoutofcampusService service;
	
	private QasDTrainingbaseoutofcampus bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDTrainingbaseoutofcampus();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDTrainingbaseoutofcampus dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDTrainingbaseoutofcampusService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDTrainingbaseoutofcampusService service) {
		this.service = service;
	}

	public QasDTrainingbaseoutofcampus getBean() {
		return bean;
	}

	public void setBean(QasDTrainingbaseoutofcampus bean) {
		this.bean = bean;
	}
