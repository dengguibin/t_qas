package	com.deceen.data.school.practiceBaseInCampus.action;
...
* @date2017-11-22 17:51:44
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDPracticebaseincampusAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDPracticebaseincampusAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDPracticebaseincampusAction.class);

	private  QasDPracticebaseincampusService service;
	
	private QasDPracticebaseincampus bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDPracticebaseincampus dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDPracticebaseincampusService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDPracticebaseincampusService service) {
		this.service = service;
	}

	public QasDPracticebaseincampus getBean() {
		return bean;
	}

	public void setBean(QasDPracticebaseincampus bean) {
		this.bean = bean;
	}
