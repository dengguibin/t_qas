package	com.deceen.data.school.informationConstruction.action;
...
* @date2017-11-22 17:45:56
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDInformationconstructionAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDInformationconstructionAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDInformationconstructionAction.class);

	private  QasDInformationconstructionService service;
	
	private QasDInformationconstruction bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDInformationconstruction dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDInformationconstructionService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDInformationconstructionService service) {
		this.service = service;
	}

	public QasDInformationconstruction getBean() {
		return bean;
	}

	public void setBean(QasDInformationconstruction bean) {
		this.bean = bean;
	}
