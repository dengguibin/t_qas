package	com.deceen.data.school.collegeEnrolPlan.action;
...
* @date2017-11-22 17:40:49
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDCollegeenrolplanAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDCollegeenrolplanAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDCollegeenrolplanAction.class);

	private  QasDCollegeenrolplanService service;
	
	private QasDCollegeenrolplan bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDCollegeenrolplan dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDCollegeenrolplanService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDCollegeenrolplanService service) {
		this.service = service;
	}

	public QasDCollegeenrolplan getBean() {
		return bean;
	}

	public void setBean(QasDCollegeenrolplan bean) {
		this.bean = bean;
	}
