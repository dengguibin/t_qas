package	com.deceen.data.school.leaderAction.action;
...
* @date2017-11-22 17:43:40
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDLeaderactionAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDLeaderactionAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDLeaderactionAction.class);

	private  QasDLeaderactionService service;
	
	private QasDLeaderaction bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDLeaderaction dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDLeaderactionService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDLeaderactionService service) {
		this.service = service;
	}

	public QasDLeaderaction getBean() {
		return bean;
	}

	public void setBean(QasDLeaderaction bean) {
		this.bean = bean;
	}
