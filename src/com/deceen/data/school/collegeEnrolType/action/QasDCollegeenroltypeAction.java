package	com.deceen.data.school.collegeEnrolType.action;
...
* @date2017-11-22 17:41:43
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDCollegeenroltypeAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDCollegeenroltypeAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDCollegeenroltypeAction.class);

	private  QasDCollegeenroltypeService service;
	
	private QasDCollegeenroltype bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDCollegeenroltype dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDCollegeenroltypeService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDCollegeenroltypeService service) {
		this.service = service;
	}

	public QasDCollegeenroltype getBean() {
		return bean;
	}

	public void setBean(QasDCollegeenroltype bean) {
		this.bean = bean;
	}
