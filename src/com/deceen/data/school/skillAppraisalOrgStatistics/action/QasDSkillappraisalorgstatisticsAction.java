package	com.deceen.data.school.skillAppraisalOrgStatistics.action;
...
* @date2017-11-22 17:59:47
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDSkillappraisalorgstatisticsAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDSkillappraisalorgstatisticsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDSkillappraisalorgstatisticsAction.class);

	private  QasDSkillappraisalorgstatisticsService service;
	
	private QasDSkillappraisalorgstatistics bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDSkillappraisalorgstatistics dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDSkillappraisalorgstatisticsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDSkillappraisalorgstatisticsService service) {
		this.service = service;
	}

	public QasDSkillappraisalorgstatistics getBean() {
		return bean;
	}

	public void setBean(QasDSkillappraisalorgstatistics bean) {
		this.bean = bean;
	}
