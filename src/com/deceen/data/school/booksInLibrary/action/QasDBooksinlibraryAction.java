package	com.deceen.data.school.booksInLibrary.action;
...
* @date2017-11-22 17:44:52
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDBooksinlibraryAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDBooksinlibraryAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDBooksinlibraryAction.class);

	private  QasDBooksinlibraryService service;
	
	private QasDBooksinlibrary bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDBooksinlibrary dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDBooksinlibraryService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDBooksinlibraryService service) {
		this.service = service;
	}

	public QasDBooksinlibrary getBean() {
		return bean;
	}

	public void setBean(QasDBooksinlibrary bean) {
		this.bean = bean;
	}
