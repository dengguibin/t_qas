package	com.deceen.data.major.practice.action;
...
* @date2017-11-23 16:08:21
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDPracticeAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDPracticeAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDPracticeAction.class);

	private  QasDPracticeService service;
	
	private QasDPractice bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDPractice dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDPracticeService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDPracticeService service) {
		this.service = service;
	}

	public QasDPractice getBean() {
		return bean;
	}

	public void setBean(QasDPractice bean) {
		this.bean = bean;
	}
