package	com.deceen.data.major.cooperate.action;
...
* @date2017-11-23 16:09:27
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDCooperateAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDCooperateAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDCooperateAction.class);

	private  QasDCooperateService service;
	
	private QasDCooperate bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDCooperate dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDCooperateService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDCooperateService service) {
		this.service = service;
	}

	public QasDCooperate getBean() {
		return bean;
	}

	public void setBean(QasDCooperate bean) {
		this.bean = bean;
	}
