package	com.deceen.data.major.majorLeader.action;
...
* @date2017-11-23 16:06:36
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDMajorleaderAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDMajorleaderAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDMajorleaderAction.class);

	private  QasDMajorleaderService service;
	
	private QasDMajorleader bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDMajorleader dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDMajorleaderService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDMajorleaderService service) {
		this.service = service;
	}

	public QasDMajorleader getBean() {
		return bean;
	}

	public void setBean(QasDMajorleader bean) {
		this.bean = bean;
	}
