package	com.deceen.data.major.lastYearEmployment.action;
...
* @date2017-11-23 16:14:22
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDLastyearemploymentAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDLastyearemploymentAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDLastyearemploymentAction.class);

	private  QasDLastyearemploymentService service;
	
	private QasDLastyearemployment bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDLastyearemployment();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDLastyearemployment dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDLastyearemploymentService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDLastyearemploymentService service) {
		this.service = service;
	}

	public QasDLastyearemployment getBean() {
		return bean;
	}

	public void setBean(QasDLastyearemployment bean) {
		this.bean = bean;
	}
