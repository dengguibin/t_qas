package	com.deceen.data.major.recruit.action;
...
* @date2017-11-23 16:10:01
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDRecruitAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDRecruitAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDRecruitAction.class);

	private  QasDRecruitService service;
	
	private QasDRecruit bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDRecruit dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDRecruitService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDRecruitService service) {
		this.service = service;
	}

	public QasDRecruit getBean() {
		return bean;
	}

	public void setBean(QasDRecruit bean) {
		this.bean = bean;
	}
