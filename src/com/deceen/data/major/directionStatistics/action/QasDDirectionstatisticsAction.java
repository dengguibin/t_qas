package	com.deceen.data.major.directionStatistics.action;
...
* @date2017-11-23 16:05:48
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDDirectionstatisticsAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDDirectionstatisticsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDDirectionstatisticsAction.class);

	private  QasDDirectionstatisticsService service;
	
	private QasDDirectionstatistics bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDDirectionstatistics();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDDirectionstatistics dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDDirectionstatisticsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDDirectionstatisticsService service) {
		this.service = service;
	}

	public QasDDirectionstatistics getBean() {
		return bean;
	}

	public void setBean(QasDDirectionstatistics bean) {
		this.bean = bean;
	}
