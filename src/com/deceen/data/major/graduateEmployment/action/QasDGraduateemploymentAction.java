package	com.deceen.data.major.graduateEmployment.action;
...
* @date2017-11-23 16:13:42
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDGraduateemploymentAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDGraduateemploymentAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDGraduateemploymentAction.class);

	private  QasDGraduateemploymentService service;
	
	private QasDGraduateemployment bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDGraduateemployment();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDGraduateemployment dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDGraduateemploymentService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDGraduateemploymentService service) {
		this.service = service;
	}

	public QasDGraduateemployment getBean() {
		return bean;
	}

	public void setBean(QasDGraduateemployment bean) {
		this.bean = bean;
	}
