package	com.deceen.data.major.graduateEmploymentUnits.action;
...
* @date2017-11-23 16:11:24
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDGraduateemploymentunitsAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDGraduateemploymentunitsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDGraduateemploymentunitsAction.class);

	private  QasDGraduateemploymentunitsService service;
	
	private QasDGraduateemploymentunits bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDGraduateemploymentunits();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDGraduateemploymentunits dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDGraduateemploymentunitsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDGraduateemploymentunitsService service) {
		this.service = service;
	}

	public QasDGraduateemploymentunits getBean() {
		return bean;
	}

	public void setBean(QasDGraduateemploymentunits bean) {
		this.bean = bean;
	}
