package	com.deceen.data.major.majorQualitativeIndicator.action;
...
* @date2017-11-23 16:15:03
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDMajorqualitativeindicatorAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDMajorqualitativeindicatorAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDMajorqualitativeindicatorAction.class);

	private  QasDMajorqualitativeindicatorService service;
	
	private QasDMajorqualitativeindicator bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDMajorqualitativeindicator();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDMajorqualitativeindicator dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDMajorqualitativeindicatorService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDMajorqualitativeindicatorService service) {
		this.service = service;
	}

	public QasDMajorqualitativeindicator getBean() {
		return bean;
	}

	public void setBean(QasDMajorqualitativeindicator bean) {
		this.bean = bean;
	}
