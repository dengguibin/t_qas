package	com.deceen.data.major.cooperateCompany.action;
...
* @date2017-11-23 16:08:53
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDCooperatecompanyAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDCooperatecompanyAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDCooperatecompanyAction.class);

	private  QasDCooperatecompanyService service;
	
	private QasDCooperatecompany bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDCooperatecompany dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDCooperatecompanyService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDCooperatecompanyService service) {
		this.service = service;
	}

	public QasDCooperatecompany getBean() {
		return bean;
	}

	public void setBean(QasDCooperatecompany bean) {
		this.bean = bean;
	}
