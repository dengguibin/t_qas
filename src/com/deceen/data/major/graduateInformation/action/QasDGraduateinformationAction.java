package	com.deceen.data.major.graduateInformation.action;
...
* @date2017-11-23 16:10:43
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDGraduateinformationAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDGraduateinformationAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDGraduateinformationAction.class);

	private  QasDGraduateinformationService service;
	
	private QasDGraduateinformation bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDGraduateinformation();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDGraduateinformation dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDGraduateinformationService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDGraduateinformationService service) {
		this.service = service;
	}

	public QasDGraduateinformation getBean() {
		return bean;
	}

	public void setBean(QasDGraduateinformation bean) {
		this.bean = bean;
	}
