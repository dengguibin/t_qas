package	com.deceen.data.major.courseMaterial.action;
...
* @date2017-11-23 16:07:12
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDCoursematerialAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDCoursematerialAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDCoursematerialAction.class);

	private  QasDCoursematerialService service;
	
	private QasDCoursematerial bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDCoursematerial dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDCoursematerialService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDCoursematerialService service) {
		this.service = service;
	}

	public QasDCoursematerial getBean() {
		return bean;
	}

	public void setBean(QasDCoursematerial bean) {
		this.bean = bean;
	}
