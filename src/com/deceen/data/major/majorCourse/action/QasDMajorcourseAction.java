package	com.deceen.data.major.majorCourse.action;
...
* @date2017-11-23 16:07:46
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDMajorcourseAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDMajorcourseAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDMajorcourseAction.class);

	private  QasDMajorcourseService service;
	
	private QasDMajorcourse bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDMajorcourse dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDMajorcourseService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDMajorcourseService service) {
		this.service = service;
	}

	public QasDMajorcourse getBean() {
		return bean;
	}

	public void setBean(QasDMajorcourse bean) {
		this.bean = bean;
	}
