package	com.deceen.data.student.qualification.action;
...
* @date2017-11-24 10:17:24
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDQualificationAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDQualificationAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDQualificationAction.class);

	private  QasDQualificationService service;
	
	private QasDQualification bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDQualification dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDQualificationService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDQualificationService service) {
		this.service = service;
	}

	public QasDQualification getBean() {
		return bean;
	}

	public void setBean(QasDQualification bean) {
		this.bean = bean;
	}
