package	com.deceen.data.student.retiredSoldiers.action;
...
* @date2017-11-24 10:37:22
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDRetiredsoldiersAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDRetiredsoldiersAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDRetiredsoldiersAction.class);

	private  QasDRetiredsoldiersService service;
	
	private QasDRetiredsoldiers bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDRetiredsoldiers dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDRetiredsoldiersService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDRetiredsoldiersService service) {
		this.service = service;
	}

	public QasDRetiredsoldiers getBean() {
		return bean;
	}

	public void setBean(QasDRetiredsoldiers bean) {
		this.bean = bean;
	}
