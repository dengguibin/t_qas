package	com.deceen.data.student.skillTraining.action;
...
* @date2017-11-24 10:18:01
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDSkilltrainingAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDSkilltrainingAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDSkilltrainingAction.class);

	private  QasDSkilltrainingService service;
	
	private QasDSkilltraining bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDSkilltraining dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDSkilltrainingService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDSkilltrainingService service) {
		this.service = service;
	}

	public QasDSkilltraining getBean() {
		return bean;
	}

	public void setBean(QasDSkilltraining bean) {
		this.bean = bean;
	}
