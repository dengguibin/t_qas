package	com.deceen.data.student.associationAndRedCrossAward.action;
...
* @date2017-11-24 10:29:35
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDAssociationandredcrossawardAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDAssociationandredcrossawardAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDAssociationandredcrossawardAction.class);

	private  QasDAssociationandredcrossawardService service;
	
	private QasDAssociationandredcrossaward bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDAssociationandredcrossaward();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDAssociationandredcrossaward dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDAssociationandredcrossawardService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDAssociationandredcrossawardService service) {
		this.service = service;
	}

	public QasDAssociationandredcrossaward getBean() {
		return bean;
	}

	public void setBean(QasDAssociationandredcrossaward bean) {
		this.bean = bean;
	}
