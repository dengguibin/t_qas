package	com.deceen.data.student.studAssociationStatistics.action;
...
* @date2017-11-24 10:30:46
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDStudassociationstatisticsAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDStudassociationstatisticsAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDStudassociationstatisticsAction.class);

	private  QasDStudassociationstatisticsService service;
	
	private QasDStudassociationstatistics bean;
	...
	public String queryList() throws Exception {
		if(bean == null){ 
			bean = new QasDStudassociationstatistics();
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDStudassociationstatistics dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDStudassociationstatisticsService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDStudassociationstatisticsService service) {
		this.service = service;
	}

	public QasDStudassociationstatistics getBean() {
		return bean;
	}

	public void setBean(QasDStudassociationstatistics bean) {
		this.bean = bean;
	}
