package	com.deceen.data.student.studentNormal.action;
...
* @date2017-11-24 10:39:24
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDStudentnormalAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDStudentnormalAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDStudentnormalAction.class);

	private  QasDStudentnormalService service;
	
	private QasDStudentnormal bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDStudentnormal dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDStudentnormalService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDStudentnormalService service) {
		this.service = service;
	}

	public QasDStudentnormal getBean() {
		return bean;
	}

	public void setBean(QasDStudentnormal bean) {
		this.bean = bean;
	}
