package	com.deceen.data.student.studentAward.action;
...
* @date2017-11-24 10:26:48
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDStudentawardAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDStudentawardAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDStudentawardAction.class);

	private  QasDStudentawardService service;
	
	private QasDStudentaward bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDStudentaward dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDStudentawardService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDStudentawardService service) {
		this.service = service;
	}

	public QasDStudentaward getBean() {
		return bean;
	}

	public void setBean(QasDStudentaward bean) {
		this.bean = bean;
	}
