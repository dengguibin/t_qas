package	com.deceen.data.student.studRegionInfo.action;
...
* @date2017-11-24 10:33:04
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDStudregioninfoAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDStudregioninfoAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDStudregioninfoAction.class);

	private  QasDStudregioninfoService service;
	
	private QasDStudregioninfo bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDStudregioninfo dsBean = service.select(bean.getId());
				if(dsBean != null){
...
//			}	
	...
	public QasDStudregioninfoService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDStudregioninfoService service) {
		this.service = service;
	}

	public QasDStudregioninfo getBean() {
		return bean;
	}

	public void setBean(QasDStudregioninfo bean) {
		this.bean = bean;
	}
