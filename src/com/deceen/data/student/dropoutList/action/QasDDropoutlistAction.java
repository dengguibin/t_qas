package	com.deceen.data.student.dropoutList.action;
...
* @date2017-11-24 10:32:29
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDDropoutlistAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDDropoutlistAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDDropoutlistAction.class);

	private  QasDDropoutlistService service;
	
	private QasDDropoutlist bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDDropoutlist dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
...
//			}	
	...
	public QasDDropoutlistService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDDropoutlistService service) {
		this.service = service;
	}

	public QasDDropoutlist getBean() {
		return bean;
	}

	public void setBean(QasDDropoutlist bean) {
		this.bean = bean;
	}
