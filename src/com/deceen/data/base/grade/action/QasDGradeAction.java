package	com.deceen.data.base.grade.action;
...
* @date2017-11-22 15:41:25
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDGradeAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDGradeAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDGradeAction.class);

	private  QasDGradeService service;
	
	private QasDGrade bean;
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDGrade dsBean = service.select(bean.getId());
				if (dsBean != null) {
					if (user != null) {
...
//			}	
	...
	public QasDGradeService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDGradeService service) {
		this.service = service;
	}

	public QasDGrade getBean() {
		return bean;
	}

	public void setBean(QasDGrade bean) {
		this.bean = bean;
	}
