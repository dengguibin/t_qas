package	com.deceen.data.base.student.action;
...
* @date2017-11-25 10:28:59
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDStudentAction")	
@SuppressWarnings({ "rawtypes", "unchecked", "serial" ,"unused" })
public class QasDStudentAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDStudentAction.class);

	private  QasDStudentService service;
	
	private QasDStudent bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDStudent dsBean = service.select(bean.getId());
				if(dsBean != null){
					if (user != null) {
	...
	public QasDStudentService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDStudentService service) {
		this.service = service;
	}

	public QasDStudent getBean() {
		return bean;
	}

	public void setBean(QasDStudent bean) {
		this.bean = bean;
	}
