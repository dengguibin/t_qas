package com.deceen.data.base.course.action;
 ...
 */
@Scope("prototype")
@Component("qasDCourseAction")
@SuppressWarnings({ "rawtypes", "unchecked", "serial" })
public class QasDCourseAction extends BaseActionSupport {

	@SuppressWarnings("unused")
	private static final Logger log = Logger.getLogger(QasDCourseAction.class);

	private QasDCourseService service;
	...
	public String save() throws Exception {
		if (bean != null) {
			...
			if (bean.getId() != null && "".equals(bean.getId()) == false) {
				...
				QasDCourse dsBean = service.select(bean.getId());
				if (dsBean != null) {
					if (user != null) {
	...
	public QasDCourseService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDCourseService service) {
