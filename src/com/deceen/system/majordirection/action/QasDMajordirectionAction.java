...
/**
*/
package	com.deceen.system.majordirection.action;
...
import com.deceen.system.majordirection.service.QasDMajordirectionService;
...
* @date2017-11-30 10:31:54
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDMajordirectionAction")	
@SuppressWarnings({ "rawtypes", "serial", "unchecked", "unused" })
public class QasDMajordirectionAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDMajordirectionAction.class);

	private  QasDMajordirectionService service;
	
	private QasDMajordirection bean;
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDMajordirection dsBean = service.select(bean.getId());
				if(dsBean != null){
					if(user!=null){
...
//			}	
	...
	public QasDMajordirectionService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDMajordirectionService service) {
		this.service = service;
	}

	public QasDMajordirection getBean() {
		return bean;
	}

	public void setBean(QasDMajordirection bean) {
		this.bean = bean;
	}
