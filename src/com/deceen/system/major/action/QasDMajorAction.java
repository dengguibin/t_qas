...
/**
*/
package	com.deceen.system.major.action;
...
* @date2017-11-30 10:54:53
* @version V1.0   
*/
@Scope("prototype")
@Component("qasDMajorAction")	
@SuppressWarnings({ "rawtypes", "serial", "unchecked", "unused" })
public class QasDMajorAction  extends BaseActionSupport{

	private static final Logger log = Logger.getLogger(QasDMajorAction.class);

	private  QasDMajorService service;
	
	private QasDMajor bean;
	...
	public String queryInfo() throws Exception {
		//回显所属学院信息
		if(bean !=null && bean.getMajorname() != null && "".equals(bean.getMajorname()) == false){
			request.setAttribute("BMMC", bean.getMajorname());
		}
	...
	public String save() throws Exception {
		if(bean != null  ){
			...
			if(bean.getId() != null && "".equals(bean.getId()) == false){
				...
				QasDMajor dsBean = service.select(bean.getId());
				if(dsBean != null){
				// 如果数据库中有此记录信息，进行更新操作
					if(user!=null){
...
//			}	
	...
	public QasDMajorService getService() {
		return service;
	}

	@Autowired
	public void setService(QasDMajorService service) {
		this.service = service;
	}

	public QasDMajor getBean() {
		return bean;
	}

	public void setBean(QasDMajor bean) {
		this.bean = bean;
	}
