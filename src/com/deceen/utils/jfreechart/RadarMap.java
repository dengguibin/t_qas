 ...
 *
 */
public class RadarMap extends SpiderWebPlot{
   ...
   /* public static void main(String args[]) throws Exception {
        ...
        String path = "D:/png/957.png";
		erstelleSpinnenDiagramm(dataset,path);
       
    }*/
    public static void erstelleSpinnenDiagramm(DefaultCategoryDataset dataset,String path) throws IOException {
      
        
        
    	RadarMap spiderwebplot = new RadarMap(dataset);
        ...
        try {
            ...
            ChartUtilities.saveChartAsPNG(new File(path), jfreechart, 500, 350);
        } finally {
            try {
                out.close();
            } catch (Exception ex) {
    ...
    RadarMap(CategoryDataset createCategoryDataset) { 
