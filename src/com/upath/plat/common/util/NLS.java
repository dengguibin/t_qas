...
public abstract class NLS {
	...
	private static final Logger logger = Logger.getLogger(NLS.class);
	/*
	...
	static void load(final String bundleName, Class clazz) {
		...
		if (logger.isDebugEnabled() == true){
			logger.debug("Time to load message bundle: " + bundleName + " was " + (System.currentTimeMillis() - start) + "ms.");
		}
	}
