...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/system/organization/";
...
<div class="dataGrid">	
<form action="${ctx}/system/organization/queryList.action"   method="post" 
id="opForm" name="opForm">
	<s:hidden name="menuId" id="menuId" />
	<s:hidden name="bean.id" id="id" />
	<s:hidden name="bean.createdby" id="createdby" />
	<s:hidden name="bean.createtime" id="createtime" />
		<div class="filter">
 		<table>
            <tbody >
             <tr>
