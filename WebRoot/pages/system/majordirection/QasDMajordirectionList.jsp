...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/system/majordirection/";
...
<div class="dataGrid">	
<form action="${ctx}/system/majordirection/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.SETUPDATE}</td>
                   	<td>&nbsp;${item.FIRSTRECRUITDATE}</td>
