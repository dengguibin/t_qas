...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/school/trainingBaseOutOfCampus/";
...
<div class="dataGrid">	
<form action="${ctx}/data/school/trainingBaseOutOfCampus/queryList.action"   method="post" 
 		...
 		<table>
            <tbody >
             <tr>
                ...
                <th>依托单位：</th>
                <td><s:textfield name="bean.supportunit" cssClass="inputText"></s:textfield></td>
                
                <th>建立日期：</th>
                <td><s:textfield name="bean.establishdate" cssClass="inputText"></s:textfield></td>
                
                <th>是否校企共建：</th>
                <td><s:textfield name="bean.iscoconstruction" cssClass="inputText"></s:textfield></td>
                <!--
                <td>
                <th>选择菜单：</th>
                <td>
