...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/school/organizationStatistics/save.action" method="post">
      ...
      <%--  <tr>
       ...
       <tr>
       	   <th width="120">教职工数<-->专职：</th>
          <td>
           <input type="text" class="inputText" id="partworknum"  maxlength="9"  name="bean.partworknum"  value="${bean.partworknum}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">教职工数<-->兼职：</th>
          <td>
           <input type="text" class="inputText" id="fullworknum"  maxlength="9"  name="bean.fullworknum"  value="${bean.fullworknum}"  />
           </td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
