...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/school/contacter/save.action" method="post">
      ...
      <%--  <tr>
       ...
       <tr>
           ...
           <td><input type="text" class="inputText"  maxlength="50"  id="contactfax" name="bean.contactfax"  value="${bean.contactfax}"  /></td>
        </tr>
       <tr>
       	   <th width="120">联系人信息<-->电子邮箱：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="contactmobile" name="bean.contactmobile"  value="${bean.contactmobile}"  /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
