...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/school/contacter/";
...
<div class="dataGrid">	
<form action="${ctx}/data/school/contacter/queryList.action"   method="post" 
 		...
 		<table>
            <tbody >
             <tr>
                ...
                <th>联系人姓名：</th>
                <td><s:textfield name="bean.contactname" cssClass="inputText"></s:textfield></td>
                
                <th>联系人职务：</th>
                <td><s:textfield name="bean.contactduty" cssClass="inputText"></s:textfield></td>
                
                <th>联系人区号-电话号码：</th>
                <td><s:textfield name="bean.contactphone" cssClass="inputText"></s:textfield></td>
                </tr>
                
                <tr>
                <th>联系人区号-传真号：</th>
                <td><s:textfield name="bean.contactfax" cssClass="inputText"></s:textfield></td>
                
                <th>联系人电子邮箱：</th>
                <td><s:textfield name="bean.contactmobile" cssClass="inputText"></s:textfield></td>
