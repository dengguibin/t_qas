...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/school/skillAppraisalOrg/";
...
<div class="dataGrid">	
<form action="${ctx}/data/school/skillAppraisalOrg/queryList.action"   method="post" 
		...
		<table>
            <tbody >
             <tr>
                ...
                <th>建立单位部门 ：</th>
                <td><s:textfield name="bean.department" cssClass="inputText"></s:textfield></td>
                <!--<td>
                <th>选择菜单：</th>
                <td>
