...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/school/skillAppraisalOrg/save.action" method="post">
       ...
       <tbody>
      <%--  <tr>
       	   <th width="120">职业技能鉴定站（所）唯一标识：<span class="warning">*</span></th>
           <td><input type="text" class="inputText"  maxlength="18"  id="id" name="bean.id"  value="${bean.id}"  datatype="*" nullmsg="请填写职业技能鉴定站（所）唯一标识"/></td>
        </tr> --%>
       <tr>
       	   <th width="120">职业技能鉴定站（所）全称：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="name" name="bean.name"  value="${bean.name}"  /></td>
        </tr>
       <tr>
       	   <th width="120">建立单位<-->级别：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="grade" name="bean.grade"  value="${bean.grade}"  /></td>
        </tr>
       <tr>
       	   <th width="120">建立单位<-->部门：</th>
