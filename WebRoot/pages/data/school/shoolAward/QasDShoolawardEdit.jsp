...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/school/shoolAward/save.action" method="post">
       ...
       <tr>
       	   <th width="120">备注：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="remark" name="bean.remark"  value="${bean.remark}"  /></td>
        </tr>
       <%-- <tr>
       	   <th width="120">状态：</th>
          <td>
