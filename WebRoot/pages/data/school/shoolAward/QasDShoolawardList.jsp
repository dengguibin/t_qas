...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/school/shoolAward/";
...
<div class="dataGrid">	
<form action="${ctx}/data/school/shoolAward/queryList.action"   method="post" 
		...
		<div class="filter" style="width: 100%;">
 		<table>
            <tbody >
             <tr>
                <th>项目名称(全称)：</th>
                <td><s:textfield name="bean.projname" cssClass="inputText"></s:textfield></td>
                ...
                <tr>-->
                <th>备注：</th>
                <td><s:textfield name="bean.remark" cssClass="inputText"></s:textfield></td>
