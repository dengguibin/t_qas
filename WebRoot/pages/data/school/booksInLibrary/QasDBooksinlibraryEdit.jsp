...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/school/booksInLibrary/save.action" method="post">
       ...
       <tr>
          ...
          <td>
           <input type="text" class="inputText" id="numofbook"  maxlength="9"  name="bean.numofbook"  value="${bean.numofbook}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">纸质图书（万册）<-->本学年新增数：</th>
          <td>
           <input type="text" class="inputText" id="numofnewbook"  maxlength="9"  name="bean.numofnewbook"  value="${bean.numofnewbook}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">专业期刊（种）<-->中文纸质专业期刊：</th>
          <td>
           <input type="text" class="inputText" id="chinesejournal"  maxlength="9"  name="bean.chinesejournal"  value="${bean.chinesejournal}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">专业期刊（种）<-->外文纸质专业期刊：</th>
          <td>
           <input type="text" class="inputText" id="foreignjournal"  maxlength="9"  name="bean.foreignjournal"  value="${bean.foreignjournal}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">专业期刊（种）<-->电子专业期刊：</th>
          <td>
           <input type="text" class="inputText" id="electronicjournal"  maxlength="9"  name="bean.electronicjournal"  value="${bean.electronicjournal}"  />
           </td>
        </tr>
     <%--   <tr>
       	   <th width="120">状态：</th>
