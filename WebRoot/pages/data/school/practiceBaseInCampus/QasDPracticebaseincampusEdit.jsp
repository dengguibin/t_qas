...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/school/practiceBaseInCampus/save.action" method="post">
       ...
       <tr>
       	   <th width="120">实践基地名称：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="name" name="bean.name"  value="${bean.name}"  /></td>
        </tr>
       <tr>
       	   <th width="120">实训基地项目<-->立项部门：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="supportdepartment" name="bean.supportdepartment"  value="${bean.supportdepartment}"  /></td>
        </tr>
       <tr>
       	   <th width="120">实训基地项目<-->批准日期（年）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="approvaldate" name="bean.approvaldate"  value="${bean.approvaldate}"  /></td>
        </tr>
       <tr>
       	   <th width="120">建筑面积（平方米）：</th>
          <td>
