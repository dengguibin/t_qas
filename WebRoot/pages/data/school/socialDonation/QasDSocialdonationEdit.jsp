...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/school/socialDonation/save.action" method="post">
       ...
       <tr>
       	   <th width="120">捐赠单位：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="donationdepartment" name="bean.donationdepartment"  value="${bean.donationdepartment}"  /></td>
        </tr>
       <tr>
       	   <th width="120">捐赠项目：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="donationproject" name="bean.donationproject"  value="${bean.donationproject}"  /></td>
        </tr>
       <tr>
       	   <th width="120">捐赠日期（年月）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="donationdate" name="bean.donationdate"  value="${bean.donationdate}"  /></td>
        </tr>
       <tr>
       	   <th width="120">捐赠性质：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="donationnature" name="bean.donationnature"  value="${bean.donationnature}"  /></td>
        </tr>
       <tr>
       	   <th width="120">捐赠价值（万元）：</th>
          <td>
           <input type="text" class="inputText" id="donationvalue"  maxlength="9"  name="bean.donationvalue"  value="${bean.donationvalue}"  />
           </td>
        </tr>
     <%--   <tr>
       	   <th width="120">状态：</th>
