...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/school/managementInformationSystem/save.action" method="post">
       ...
       <tbody>
       <%-- <tr>
       	   <th width="120">信息系统唯一标识：<span class="warning">*</span></th>
           <td><input type="text" class="inputText"  maxlength="18"  id="id" name="bean.id"  value="${bean.id}"  datatype="*" nullmsg="请填写信息系统唯一标识"/></td>
        </tr> --%>
       <tr>
       	 <th width="120">类型：</th>
         <td><input type="text" class="inputText" id="type" name="bean.type"  value="${bean.type}" /></td>
        </tr>
       <tr>
       	 <th width="120">系统名称(全称)：</th>
         <td><input type="text" class="inputText" id="systemname" name="bean.systemname"  value="${bean.systemname}" /></td>
        </tr>
       <tr>
       	 <th width="120">来源：</th>
         <td><input type="text" class="inputText" id="source" name="bean.source"  value="${bean.source}" /></td>
        </tr>
       <tr>
       	 <th width="120">开发单位名称(全称)：</th>
         <td><input type="text" class="inputText" id="developmentunit" name="bean.developmentunit"  value="${bean.developmentunit}" /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
