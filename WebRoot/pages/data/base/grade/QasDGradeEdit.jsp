...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/base/grade/save.action" method="post">
       ...
       <tbody>
       <%-- <tr>
       	   <th width="120">班级唯一标识：<span class="warning">*</span></th>
           <td><input type="text" class="inputText"  maxlength="18"  id="id" name="bean.id"  value="${bean.id}"  datatype="*" nullmsg="请填写班级唯一标识"/></td>
        </tr> --%>
       <tr>
       	   <th width="120">专业方向名称：</th>
           <td><input type="text" class="inputText"  maxlength="18"  id="directioniddirectionid" name="bean.directioniddirectionid"  value="${bean.directioniddirectionid}"  /></td>
        </tr>
       <tr>
       	   <th width="120">班级代码：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="gradecode" name="bean.gradecode"  value="${bean.gradecode}"  /></td>
        </tr>
       <tr>
       	   <th width="120">班级名称：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="gradename" name="bean.gradename"  value="${bean.gradename}"  /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
