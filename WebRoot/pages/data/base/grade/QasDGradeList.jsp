...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/base/grade/";
...
<div class="dataGrid">	
<form action="${ctx}/data/base/grade/queryList.action"   method="post" 
		...
		<div class="filter">
 		<table>
            <tbody >
             <tr>
                <th>班级名称：</th>
                <td><s:textfield name="bean.gradename" cssClass="inputText"></s:textfield></td>
                <td>
                <th>专业方向名称：</th>
                <td>
                 <s:textfield name="bean.directioniddirectionid" cssClass="inputText"></s:textfield>
                </td>
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.DIRECTIONIDDIRECTIONID}</td>
