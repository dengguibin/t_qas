...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/teacherPublishedPaper/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/teacherPublishedPaper/queryList.action"   method="post" 
