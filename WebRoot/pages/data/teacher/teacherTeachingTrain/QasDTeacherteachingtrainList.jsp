...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/teacherTeachingTrain/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/teacherTeachingTrain/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
                   ...
                   <%-- 	<td>&nbsp;${item.ID}</td> --%>
                   	...
                   	<td>&nbsp;${item.TEACHINGTRAINPROJNAME}</td>
                   	<td>&nbsp;${item.TEACHINGTRAINDAY}</td>
                   	<td>&nbsp;${item.TEACHINGTRAINHOUR}</td>
                   	<td>&nbsp;${item.TEACHINGTRAINSITE}</td>
                   	<td>&nbsp;${item.TEACHINGTRAININGDISPATCHEDDEPARTMENT}</td>
                   	<td>&nbsp;${item.STATUS}</td>
