...
<s:hidden name="menuId" id="menuId"/>
	<div class="formtitle"><span>放在这里提示</span></div>
       ...
       <tr>
           ...
           <td>${bean.teachingtrainprojname}</td>
        </tr>
       <tr>
    	   <th width="120">时间（天）：</th>
           <td>${bean.teachingtrainday}</td>
        </tr>
       <tr>
    	   <th width="120">学时数（小时）：</th>
           <td>${bean.teachingtrainhour}</td>
        </tr>
       <tr>
    	   <th width="120">地点：</th>
           <td>${bean.teachingtrainsite}</td>
        </tr>
       <tr>
    	   <th width="120">派出部门：</th>
           <td>${bean.teachingtrainingdispatcheddepartment}</td>
        </tr>
       <tr>
    	   <th width="120">状态：</th>
           <td>${bean.status}</td>
