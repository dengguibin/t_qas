...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/teacherResearch/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/teacherResearch/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.RESEARCHNATURE}</td>
                   	<td>&nbsp;${item.RESEARCHTYPE}</td>
                   	<td>&nbsp;${item.RESEARCHNAME}</td>
                   	<td>&nbsp;${item.RESEARCHISHORIZONTALISSUE}</td>
                   	<td>&nbsp;${item.RESEARCHLEVEL}</td>
                   	<td>&nbsp;${item.RESEARCHESTABLISHDATE}</td>
                   	<td>&nbsp;${item.RESEARCHFUND}</td>
                   	<td>&nbsp;${item.RESEARCHAMOUNTRECEIVED}</td>
                   	<td>&nbsp;${item.RESEARCHCOMPLETEORDER}</td>
                   	<td>&nbsp;${item.RESEARCHSOURCE}</td>
                   	<td>&nbsp;${item.STATUS}</td>
