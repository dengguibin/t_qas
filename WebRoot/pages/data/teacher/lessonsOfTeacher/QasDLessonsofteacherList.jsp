...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/lessonsOfTeacher/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/lessonsOfTeacher/queryList.action"   method="post" 
		  ...
		  <table id="dataTable" class="list_table">
            <thead>
              <tr>
                ...
                <th>教学工作量（学时）</th>
                <th>实际授课课时</th>
              <!--   <th>主要开设实践项目名称(全称)--实验</th>
                <th>主要开设实践项目名称(全称)--实训</th>
                <th>主要开设实践项目名称(全称)--实习</th>
                <th>是否行政班授课</th> -->
                <th>授课学期</th>
                <th>状态</th>
                <!-- <th>创建人</th>
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.COURSEID}</td>
                   	<td>&nbsp;${item.TEACHINGTASK}</td>
                   	<td>&nbsp;${item.ISMERGECLASS}</td>
                   	<td>&nbsp;${item.ISPARALLELCLASS}</td>
                   	<td>&nbsp;${item.TEACHINGLOAD}</td>
                   	<td>&nbsp;${item.HOUR}</td>
                   	<%-- <td>&nbsp;${item.EXPERIMENT}</td>
                   	<td>&nbsp;${item.TRAINING}</td>
                   	<td>&nbsp;${item.PRACTICE}</td>
                   	<td>&nbsp;${item.ISEXECUTIVECLASS}</td> --%>
                   	<td>&nbsp;${item.TERM}</td>
                   	<td>&nbsp;${item.STATUS}</td>
