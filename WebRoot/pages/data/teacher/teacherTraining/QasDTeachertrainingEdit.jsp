...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teacher/teacherTraining/save.action" method="post">
       ...
       <tr>
       	   <th width="120">培训项目名称(全称)：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="trainingname" name="bean.trainingname"  value="${bean.trainingname}"  /></td>
        </tr>
       <tr>
       	   <th width="120">时间（天）：</th>
          <td>
           <input type="text" class="inputText" id="trainingday"  maxlength="9"  name="bean.trainingday"  value="${bean.trainingday}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">学时数（小时）：</th>
          <td>
           <input type="text" class="inputText" id="teachinghour"  maxlength="9"  name="bean.teachinghour"  value="${bean.teachinghour}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">国家：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="nationality" name="bean.nationality"  value="${bean.nationality}"  /></td>
        </tr>
       <tr>
       	   <th width="120">地点：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="trainingsite" name="bean.trainingsite"  value="${bean.trainingsite}"  /></td>
        </tr>
       <tr>
       	   <th width="120">派出部门：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="trainingdispatcheddepartment" name="bean.trainingdispatcheddepartment"  value="${bean.trainingdispatcheddepartment}"  /></td>
        </tr>
     <%--   <tr>
       	   <th width="120">状态：</th>
          <td>
