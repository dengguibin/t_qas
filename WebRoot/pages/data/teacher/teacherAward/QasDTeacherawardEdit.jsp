...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teacher/teacherAward/save.action" method="post">
    ...
    <%--    <tr>
       ...
       <tr>
       	   <th width="120">获奖名称(全称)：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="awardname" name="bean.awardname"  value="${bean.awardname}"  /></td>
        </tr>
       <tr>
       	   <th width="120">级别：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="awardgrade" name="bean.awardgrade"  value="${bean.awardgrade}"  /></td>
        </tr>
       <tr>
       	   <th width="120">颁奖单位：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="awardingunit" name="bean.awardingunit"  value="${bean.awardingunit}"  /></td>
        </tr>
       <tr>
       	   <th width="120">是否主持：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="awardishost" name="bean.awardishost"  value="${bean.awardishost}"  /></td>
        </tr>
       <tr>
       	   <th width="120">获奖类别：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="awardtype" name="bean.awardtype"  value="${bean.awardtype}"  /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
