...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/teacherAward/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/teacherAward/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
                  ...
                  <%--  	<td>&nbsp;${item.ID}</td> --%>
                   	...
                   	<td>&nbsp;${item.AWARDGRADE}</td>
                   	<td>&nbsp;${item.AWARDINGUNIT}</td>
                   	<td>&nbsp;${item.AWARDISHOST}</td>
