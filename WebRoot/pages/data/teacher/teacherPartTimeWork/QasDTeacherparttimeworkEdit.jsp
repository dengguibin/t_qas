...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teacher/teacherPartTimeWork/save.action" method="post">
     ...
     <%--   <tr>
       ...
       <tr>
       	   <th width="120">兼职单位名称(全称)：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="parttimeunit" name="bean.parttimeunit"  value="${bean.parttimeunit}"  /></td>
        </tr>
       <tr>
       	   <th width="120">兼职时间（天）：</th>
          <td>
           <input type="text" class="inputText" id="parttimeday"  maxlength="9"  name="bean.parttimeday"  value="${bean.parttimeday}"  />
           </td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
