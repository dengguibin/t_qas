...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/teacherPartTimeWork/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/teacherPartTimeWork/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.PARTTIMEUNIT}</td>
                   	<td>&nbsp;${item.PARTTIMEDAY}</td>
                   	<td>&nbsp;${item.STATUS}</td>
