...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/teacherTechnicalMonopoly/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/teacherTechnicalMonopoly/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.TECHNICALMONOPOLYTYPE}</td>
                   	<td>&nbsp;${item.TECHNICALMONOPOLYRECEIVEDATE}</td>
                   	<td>&nbsp;${item.TECHNICALMONOPOLYNAME}</td>
                   	<td>&nbsp;${item.TECHNICALMONOPOLYCODE}</td>
                   	<td>&nbsp;${item.TECHNICALMONOPOLYISHOST}</td>
                   	<td>&nbsp;${item.STATUS}</td>
