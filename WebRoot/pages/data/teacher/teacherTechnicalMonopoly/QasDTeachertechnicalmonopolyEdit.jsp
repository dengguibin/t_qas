...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teacher/teacherTechnicalMonopoly/save.action" method="post">
    ...
    <%--    <tr>
       ...
       <tr>
           ...
           <td><input type="text" class="inputText"  maxlength="50"  id="technicalmonopolytype" name="bean.technicalmonopolytype"  value="${bean.technicalmonopolytype}"  /></td>
        </tr>
       <tr>
       	   <th width="120">获得日期（年月）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="technicalmonopolyreceivedate" name="bean.technicalmonopolyreceivedate"  value="${bean.technicalmonopolyreceivedate}"  /></td>
        </tr>
       <tr>
       	   <th width="120">技术专利（发明）名称(全称)：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="technicalmonopolyname" name="bean.technicalmonopolyname"  value="${bean.technicalmonopolyname}"  /></td>
        </tr>
       <tr>
       	   <th width="120">技术专利（发明）编号：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="technicalmonopolycode" name="bean.technicalmonopolycode"  value="${bean.technicalmonopolycode}"  /></td>
        </tr>
       <tr>
       	   <th width="120">是否主持：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="technicalmonopolyishost" name="bean.technicalmonopolyishost"  value="${bean.technicalmonopolyishost}"  /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
