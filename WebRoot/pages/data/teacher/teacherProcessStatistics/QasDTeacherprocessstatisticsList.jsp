...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/teacherProcessStatistics/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/teacherProcessStatistics/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.COURSEID}</td>
                   	<td>&nbsp;${item.ABSENCE}</td>
                   	<td>&nbsp;${item.SATISFACTIONTIMES}</td>
                   	<td>&nbsp;${item.TRANSFERFORPRIVATE}</td>
                   	<td>&nbsp;${item.SUPERVISIONSCORE}</td>
                   	<td>&nbsp;${item.TEACHINGPROGRAM}</td>
                   	<%-- <td>&nbsp;${item.REMARK}</td> --%>
                   	<td>&nbsp;${item.STATUS}</td>
