...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teacher/teacherSecondment/save.action" method="post">
      ...
      <%--  <tr>
       ...
       <tr>
       	   <th width="120">单位名称(全称)	：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="secondmentdepartmentname" name="bean.secondmentdepartmentname"  value="${bean.secondmentdepartmentname}"  /></td>
        </tr>
       <tr>
       	   <th width="120">岗位：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="secondmentunit" name="bean.secondmentunit"  value="${bean.secondmentunit}"  /></td>
        </tr>
       <tr>
       	   <th width="120">时间（天）：</th>
          <td>
           <input type="text" class="inputText" id="secondmentday"  maxlength="9"  name="bean.secondmentday"  value="${bean.secondmentday}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">学时数（小时）：</th>
          <td>
           <input type="text" class="inputText" id="secondmenthour"  maxlength="9"  name="bean.secondmenthour"  value="${bean.secondmenthour}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">派出部门：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="secondmentdispatcheddepartment" name="bean.secondmentdispatcheddepartment"  value="${bean.secondmentdispatcheddepartment}"  /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
