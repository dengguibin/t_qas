...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teacher/teacherSecondment/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teacher/teacherSecondment/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.SECONDMENTDEPARTMENTNAME}</td>
                   	<td>&nbsp;${item.SECONDMENTUNIT}</td>
                   	<td>&nbsp;${item.SECONDMENTDAY}</td>
                   	<td>&nbsp;${item.SECONDMENTHOUR}</td>
                   	<td>&nbsp;${item.SECONDMENTDISPATCHEDDEPARTMENT}</td>
                   	<td>&nbsp;${item.STATUS}</td>
