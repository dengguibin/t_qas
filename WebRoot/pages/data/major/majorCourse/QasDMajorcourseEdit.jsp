...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/major/majorCourse/save.action" method="post">
      ...
      <%--  <tr>
       ...
       <tr>
           ...
           <td><input type="text" class="inputText"  maxlength="50"  id="coursenature" name="bean.coursenature"  value="${bean.coursenature}"  /></td>
        </tr>
       <tr>
       	   <th width="120">教学计划规定课时数（学时）：</th>
          <td>
           <input type="text" class="inputText" id="planhours"  maxlength="9"  name="bean.planhours"  value="${bean.planhours}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">实践课课时数：</th>
          <td>
           <input type="text" class="inputText" id="normalhours"  maxlength="9"  name="bean.normalhours"  value="${bean.normalhours}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">授课年级：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="classgrade" name="bean.classgrade"  value="${bean.classgrade}"  /></td>
        </tr>
       <tr>
          <th width="120">主要授课地点：</th>
          <td>
                <textarea id="classaddress"  maxlength="127.5" name="bean.classaddress" class="textinput2" >${bean.classaddress}</textarea>
           </td>
        </tr>
       <tr>
          <th width="120">主要授课方式：</th>
          <td>
                <textarea id="classtype"  maxlength="127.5" name="bean.classtype" class="textinput2" >${bean.classtype}</textarea>
           </td>
        </tr>
       <tr>
          <th width="120">考试/考核主要方法：</th>
          <td>
                <textarea id="examemethod"  maxlength="127.5" name="bean.examemethod" class="textinput2" >${bean.examemethod}</textarea>
           </td>
        </tr>
       <tr>
       	   <th width="120">课证融通课程：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="papertocourse" name="bean.papertocourse"  value="${bean.papertocourse}"  /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
