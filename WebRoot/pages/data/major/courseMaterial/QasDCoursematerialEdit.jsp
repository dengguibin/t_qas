...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/major/courseMaterial/save.action" method="post">
      ...
      <%--  <tr>
       ...
       <tr>
          <th width="120">教材名称（全称）：</th>
          <td>
                <textarea id="bookname"  maxlength="127.5" name="bean.bookname" class="textinput2" >${bean.bookname}</textarea>
           </td>
        </tr>
       <tr>
       	   <th width="120">版本日期（年）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="bookyear" name="bean.bookyear"  value="${bean.bookyear}"  /></td>
        </tr>
       <tr>
          <th width="120">出版社：</th>
          <td>
                <textarea id="bookpulish"  maxlength="127.5" name="bean.bookpulish" class="textinput2" >${bean.bookpulish}</textarea>
           </td>
        </tr>
       <tr>
          <th width="120">第一作者：</th>
          <td>
                <textarea id="bookautor"  maxlength="127.5" name="bean.bookautor" class="textinput2" >${bean.bookautor}</textarea>
           </td>
        </tr>
       <tr>
       	   <th width="120">教材性质：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="booknature" name="bean.booknature"  value="${bean.booknature}"  /></td>
        </tr>
       <tr>
       	   <th width="120">教材类型：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="booktype" name="bean.booktype"  value="${bean.booktype}"  /></td>
        </tr>
       <%-- <tr>
       	   <th width="120">状态：</th>
          <td>
