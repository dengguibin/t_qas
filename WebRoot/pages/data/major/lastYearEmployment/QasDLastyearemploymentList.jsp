...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/major/lastYearEmployment/";
...
<div class="dataGrid">	
<form action="${ctx}/data/major/lastYearEmployment/queryList.action"   method="post" 
		  ...
		  <table id="dataTable" class="list_table">
            <thead>
              <tr>
                ...
                <th>毕业生就业情况<-->升迁数（人）</th>
                <th>毕业生就业情况<-->转岗数（人）</th>
                <%-- <th>毕业生用人单位满意情况<-->满意或基本满意人数</th>
                <th>毕业生用人单位满意情况<-->一般满意人数</th>
                <th>毕业生用人单位满意情况<-->不满意人数</th> 
                <th>毕业生的教学满意人数</th>
                <th>毕业生对母校的满意人数</th>
                <th>毕业生工作与职业期待吻合人数</th>
                <th>毕业生对基本工作能力总体满足人数</th>
                <th>毕业生对核心知识的总体满足人数</th>
                <th>毕业生的就业现状满意人数 </th>--%>
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.NOMAL}</td>
                   	<td>&nbsp;${item.DISSATISFIED}</td>
                   	<td>&nbsp;${item.SATISFIEDWITHTEACHING}</td>
                   	<td>&nbsp;${item.SATISFIEDWITHCOLLEGE}</td>
                   	<td>&nbsp;${item.WORKANDCAREEREXPECTATIONSMATCH}</td>
                   	<td>&nbsp;${item.SATISFIEDWITHWORKABILITY}</td>
                   	<td>&nbsp;${item.SATISFIEDWITHCOREKNOWLEDGE}</td>
                   	<td>&nbsp;${item.SATISFIEDWITHEMPLOYMENT}</td> --%>
                   	<%-- <td>&nbsp;${item.STATUS}</td>
