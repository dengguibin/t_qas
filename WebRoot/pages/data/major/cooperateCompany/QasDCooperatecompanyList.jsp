...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/major/cooperateCompany/";
...
<div class="dataGrid">	
<form action="${ctx}/data/major/cooperateCompany/queryList.action"   method="post" 
		...
		<div class="filter">
 		<table>
            <tbody >
             <tr>
                <th>企业名称：</th>
                <td><s:textfield name="bean.company" cssClass="inputText"></s:textfield></td>
                <td>
                <th>合作开始日期（年月）：</th>
                <td><s:textfield name="bean.starttime" cssClass="inputText"></s:textfield></td>
                <td>
                <td>
