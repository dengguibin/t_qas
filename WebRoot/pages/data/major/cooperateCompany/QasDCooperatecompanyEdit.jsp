...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/major/cooperateCompany/save.action" method="post">
  ...
  <%--      <tr>
       ...
       <tr>
       	   <th width="120">企业名称(全称)：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="company" name="bean.company"  value="${bean.company}"  /></td>
        </tr>
       <tr>
       	   <th width="120">合作开始日期（年月）：</th>
