...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teaching/baseInfoOfEmploymentGuidance/save.action" method="post">
       ...
       <tr>
       	   <th width="120">从事招生就业工作年限（年） ：</th>
          <td>
           <input type="text" class="inputText" id="managerage"  maxlength="9"  name="bean.managerage"  value="${bean.managerage}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">是否就业指导规划师：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="iscareerguidance" name="bean.iscareerguidance"  value="${bean.iscareerguidance}"  /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
