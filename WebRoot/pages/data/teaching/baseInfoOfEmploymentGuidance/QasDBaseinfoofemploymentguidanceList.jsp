...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teaching/baseInfoOfEmploymentGuidance/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teaching/baseInfoOfEmploymentGuidance/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.POSTAGE}</td>
                   	<td>&nbsp;${item.MANAGERAGE}</td>
                   	<td>&nbsp;${item.ISCAREERGUIDANCE}</td>
                   	<td>&nbsp;${item.STATUS}</td>
