...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teaching/baseInfoOfTeachingResearcher/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teaching/baseInfoOfTeachingResearcher/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
                   ...
                   <%-- 	<td>&nbsp;${item.ID}</td> --%>
                   	...
                   	<td>&nbsp;${item.RESEARCHCOUNT}</td>
                   	<td>&nbsp;${item.RESEARCHLEVEL}</td>
                   	<td>&nbsp;${item.RESEARCHCOOPERATION}</td>
                   	<td>&nbsp;${item.STATUS}</td>
