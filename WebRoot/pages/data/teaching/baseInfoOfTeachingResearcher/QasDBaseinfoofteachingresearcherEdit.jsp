...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teaching/baseInfoOfTeachingResearcher/save.action" method="post">
      ...
      <%--  <tr>
       ...
       <tr>
           ...
           <td><input type="text" class="inputText"  maxlength="50"  id="employeeid" name="bean.employeeid"  value="${bean.employeeid}"  /></td>
        </tr>
       <tr>
       ...
       <tr>
       	   <th width="120">教研成果<-->数量（项）：</th>
          <td>
           <input type="text" class="inputText" id="researchcount"  maxlength="9"  name="bean.researchcount"  value="${bean.researchcount}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">教研成果<-->最高等级：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="researchlevel" name="bean.researchlevel"  value="${bean.researchlevel}"  /></td>
        </tr>
       <tr>
       	   <th width="120">教研成果<-->合作情况：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="researchcooperation" name="bean.researchcooperation"  value="${bean.researchcooperation}"  /></td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
          <td>
