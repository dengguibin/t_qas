...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teaching/cooperateProject/save.action" method="post">
    ...
    <%--    <tr>
       ...
       <tr>
          ...
          <td>
                <textarea id="content"  maxlength="500" name="bean.content" class="textinput2" >${bean.content}</textarea>
           </td>
        </tr>
       <tr>
       	   <th width="120">合作企业名称：</th>
           <td><input type="text" class="inputText"  maxlength="18"  id="companyid" name="bean.companyid"  value="${bean.companyid}"  /></td>
        </tr>
       <tr>
       	   <th width="120">类别：</th>
       ...
       <tr>
           ...
           <td><input type="text" class="inputText"  maxlength="50"  id="ishorizontal" name="bean.ishorizontal"  value="${bean.ishorizontal}"  /></td>
        </tr>
       <tr>
       	   <th width="120">金额（万元）：</th>
          <td>
           <input type="text" class="inputText" id="amount"  maxlength="9"  name="bean.amount"  value="${bean.amount}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">开始时间：</th>
          <td>
             <input type="text" class="inputDate" onclick="new WdatePicker()" id="starttime" name="bean.starttime"  value="${starttime}" />
          </td>
        </tr>
       <tr>
       	   <th width="120">结束时间	：</th>
          <td>
             <input type="text" class="inputDate" onclick="new WdatePicker()" id="endtime" name="bean.endtime"  value="${endtime}" />
          </td>
        </tr>
       <tr>
