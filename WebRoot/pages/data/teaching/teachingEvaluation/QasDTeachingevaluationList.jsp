...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teaching/teachingEvaluation/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teaching/teachingEvaluation/queryList.action"   method="post" 
		  ...
		  <table id="dataTable" class="list_table">
            <thead>
              <tr>
                ...
                <th>评教起始日期（年月）</th>
                <th>评教终止日期（年月）</th>
                <th>评教客体（教师）<-->评教客体（教师）<-->参与数（人）</th>
                <th>评教客体（教师）<-->评教客体（教师）<-->总数（人）</th>
                <th>评教主体参与度<-->学生<-->参与数（人）</th>
                <th>评教主体参与度<-->学生<-->总数（人）</th>
                <th>评教主体参与度<-->同行<-->参与数（人）</th>
                <th>评教主体参与度<-->同行<-->总数（人）</th>
                <th>评教主体参与度<-->校领导<-->参与数（人）</th>
                <th>评教主体参与度<-->校领导<-->总数（人）</th>
                <th>评教主体参与度<-->社会<-->参与数（人）</th>
                <th>评教主体参与度<-->社会<-->总数（人）</th>
                <th>状态</th>
                <th>创建人</th>
                <th>创建时间</th>
                <th>修改人</th>
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	<%-- <td>&nbsp;${item.ID}</td> --%>
                   	<td>&nbsp;${item.TEACHINGEVALUATIONSTARTTIME}</td>
                   	<td>&nbsp;${item.TEACHINGEVALUATIONENDTIME}</td>
                   	<td>&nbsp;${item.NUMOFPARTICIPANTTEACHER}</td>
                   	<td>&nbsp;${item.TOTALNUMOFTEACHER}</td>
                   	<td>&nbsp;${item.NUMOFSTUDENT}</td>
                   	<td>&nbsp;${item.TOTALNUMOFSTUDENT}</td>
                   	<td>&nbsp;${item.NUMOFPARTICIPANTSCHOOLMATE}</td>
                   	<td>&nbsp;${item.TOTALNUMOFSCHOOLMATE}</td>
                   	<td>&nbsp;${item.NUMOFPARTICIPANTLEADER}</td>
                   	<td>&nbsp;${item.TOTALNUMOFLEADER}</td>
                   	<td>&nbsp;${item.NUMOFPARTICIPANTSOCIETY}</td>
                   	<td>&nbsp;${item.TOTALNUMOFSOCIETY}</td>
                   	<td>&nbsp;${item.STATUS}</td>
