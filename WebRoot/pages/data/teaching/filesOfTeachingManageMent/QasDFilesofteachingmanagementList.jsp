...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teaching/filesOfTeachingManageMent/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teaching/filesOfTeachingManageMent/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.PUBLISHEDDEPARTMENT}</td>
                   	<td>&nbsp;${item.MODIFY}</td>
