...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teaching/filesOfTeachingManageMent/save.action" method="post">
      ...
      <%--  <tr>
       ...
       <tr>
       	   <th width="120">文件名称(全称)及文号：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="name" name="bean.name"  value="${bean.name}"  /></td>
        </tr>
       <tr>
       	   <th width="120">发布日期（年月）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="publisheddate" name="bean.publisheddate"  value="${bean.publisheddate}"  /></td>
        </tr>
       <tr>
       	   <th width="120">发布部门	：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="publisheddepartment" name="bean.publisheddepartment"  value="${bean.publisheddepartment}"  /></td>
        </tr>
       <tr>
       	   <th width="120">变更情况（新增、修改、取消）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="modify" name="bean.modify"  value="${bean.modify}"  /></td>
        </tr>
       <tr>
       	   <th width="120">变更日期（年月）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="modifidate" name="bean.modifidate"  value="${bean.modifidate}"  /></td>
        </tr>
       <tr>
       	   <th width="120">负责部门：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="responsibledepartment" name="bean.responsibledepartment"  value="${bean.responsibledepartment}"  /></td>
        </tr>
       <%-- <tr>
       	   <th width="120">状态：</th>
          <td>
