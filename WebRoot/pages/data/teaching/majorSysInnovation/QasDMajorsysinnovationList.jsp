...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teaching/majorSysInnovation/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teaching/majorSysInnovation/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.MAININNOVATION}</td>
                   	<td>&nbsp;${item.IMPLEMENTATIONDATE}</td>
                   	<td>&nbsp;${item.MAINACHIEVEMENT}</td>
                   	<td>&nbsp;${item.STATUS}</td>
