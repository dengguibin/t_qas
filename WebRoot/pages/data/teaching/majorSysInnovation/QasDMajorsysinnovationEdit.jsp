...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teaching/majorSysInnovation/save.action" method="post">
      ...
      <%--  <tr>
       ...
       <tr>
           ...
           <td><input type="text" class="inputText"  maxlength="50"  id="maininnovation" name="bean.maininnovation"  value="${bean.maininnovation}"  /></td>
        </tr>
       <tr>
       	   <th width="120">实施日期（年月）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="implementationdate" name="bean.implementationdate"  value="${bean.implementationdate}"  /></td>
        </tr>
       <tr>
       	   <th width="120">主要成果	：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="mainachievement" name="bean.mainachievement"  value="${bean.mainachievement}"  /></td>
        </tr>
    <%--    <tr>
       	   <th width="120">状态：</th>
          <td>
