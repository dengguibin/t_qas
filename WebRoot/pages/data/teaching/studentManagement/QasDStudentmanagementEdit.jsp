...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teaching/studentManagement/save.action" method="post">
       ...
       <tr>
       	   <th width="120">本岗位工作年限（年：</th>
          <td>
           <input type="text" class="inputText" id="postage"  maxlength="9"  name="bean.postage"  value="${bean.postage}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">从事教学管理年限（年）：</th>
          <td>
           <input type="text" class="inputText" id="managerage"  maxlength="9"  name="bean.managerage"  value="${bean.managerage}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">是否专职政治辅导员：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="ispoliticalinstructor" name="bean.ispoliticalinstructor"  value="${bean.ispoliticalinstructor}"  /></td>
        </tr>
       <tr>
       	   <th width="120">是否专职心理咨询师：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="ispsychologist" name="bean.ispsychologist"  value="${bean.ispsychologist}"  /></td>
        </tr>
       <%-- <tr>
       	   <th width="120">状态：</th>
          <td>
