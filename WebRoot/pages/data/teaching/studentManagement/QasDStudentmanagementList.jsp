...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/teaching/studentManagement/";
...
<div class="dataGrid">	
<form action="${ctx}/data/teaching/studentManagement/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
                   ...
                   <%-- 	<td>&nbsp;${item.ID}</td> --%>
                   	...
                   	<td>&nbsp;${item.ISPOLITICALINSTRUCTOR}</td>
                   	<td>&nbsp;${item.ISPSYCHOLOGIST}</td>
                   	<td>&nbsp;${item.STATUS}</td>
