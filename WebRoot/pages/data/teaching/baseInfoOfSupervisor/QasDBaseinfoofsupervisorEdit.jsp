...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teaching/baseInfoOfSupervisor/save.action" method="post">
    ...
    <%--    <tr>
       ...
       <tr>
       	   <th width="120">周工作时数（小时）：</th>
          <td>
           <input type="text" class="inputText" id="hoursperweek"  maxlength="9"  name="bean.hoursperweek"  value="${bean.hoursperweek}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">教龄（年） ：</th>
          <td>
           <input type="text" class="inputText" id="teachingyear"  maxlength="9"  name="bean.teachingyear"  value="${bean.teachingyear}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">职称：</th>
