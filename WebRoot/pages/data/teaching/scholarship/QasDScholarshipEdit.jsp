...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/teaching/scholarship/save.action" method="post">
     ...
     <%--   <tr>
       ...
       <tr>
           ...
           <td><input type="text" class="inputText"  maxlength="50"  id="subjectname" name="bean.subjectname"  value="${bean.subjectname}"  /></td>
        </tr>
       <tr>
       	   <th width="120">项目种类：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="subjecttype" name="bean.subjecttype"  value="${bean.subjecttype}"  /></td>
        </tr>
       <tr>
       	   <th width="120">奖助范围：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="rangeofreward" name="bean.rangeofreward"  value="${bean.rangeofreward}"  /></td>
        </tr>
       <tr>
       	   <th width="120">奖助人数：</th>
          <td>
           <input type="text" class="inputText" id="rewardnum"  maxlength="9"  name="bean.rewardnum"  value="${bean.rewardnum}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">奖助金额（万元）：</th>
          <td>
           <input type="text" class="inputText" id="rewardamount"  maxlength="9"  name="bean.rewardamount"  value="${bean.rewardamount}"  />
           </td>
        </tr>
      <%--  <tr>
       	   <th width="120">状态：</th>
