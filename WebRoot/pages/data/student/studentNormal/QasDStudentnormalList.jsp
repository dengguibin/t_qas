...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/student/studentNormal/";
...
<div class="dataGrid">	
<form action="${ctx}/data/student/studentNormal/queryList.action"   method="post" 
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	             <tr align="center">
	                ...
	                <td>&nbsp;${stat.count }</td>
                   	...
                   	<td>&nbsp;${item.PREMATURELEAVE}</td>
                   	<td>&nbsp;${item.LEAVES}</td>
                   	<td>&nbsp;${item.EVALUATIONPOINT}</td>
                   	<td>&nbsp;${item.DISCIPLINE}</td>
                   	<td>&nbsp;${item.CRIME}</td>
                   	<td>&nbsp;${item.GROUPEVENT}</td>
                   	<td>&nbsp;${item.CASUALTIES}</td>
                   	<td>&nbsp;${item.PUNISHMENTTIME}</td>
                   	<td>&nbsp;${item.STATUS}</td>
