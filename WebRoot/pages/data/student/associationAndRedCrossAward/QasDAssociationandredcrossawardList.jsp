...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/student/associationAndRedCrossAward/";
...
<div class="dataGrid">	
<form action="${ctx}/data/student/associationAndRedCrossAward/queryList.action"   method="post" 
		...
		<div class="filter" style="width: 100%;">
 		...
 		<table>
            <tbody >
             <tr>
                <th>社团：</th>
                <td><s:textfield name="bean.communityid" cssClass="inputText"></s:textfield></td>
                
                <th>项目名称：</th>
                <td><s:textfield name="bean.subjectname" cssClass="inputText"></s:textfield></td>
                
                <th>获奖级别：</th>
                <td><s:textfield name="bean.awardlevel" cssClass="inputText"></s:textfield></td>
                
                <th>获奖日期：</th>
                <td><s:textfield name="bean.awarddate" cssClass="inputText"></s:textfield></td>
                </tr>
                
                <tr>
                <th>颁奖单位：</th>
                <td><s:textfield name="bean.awardingunit" cssClass="inputText"></s:textfield></td>
                
                <th>指导教师名单：</th>
                <td><s:textfield name="bean.tutors" cssClass="inputText"></s:textfield></td>
