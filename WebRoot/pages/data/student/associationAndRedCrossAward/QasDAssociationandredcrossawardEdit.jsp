...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/student/associationAndRedCrossAward/save.action" method="post">
       ...
       <tr>
       	   <th width="120">获奖级别：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="awardlevel" name="bean.awardlevel"  value="${bean.awardlevel}"  /></td>
        </tr>
       <tr>
