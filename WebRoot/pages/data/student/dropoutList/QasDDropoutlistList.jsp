...
<!--
		function  opreate(args,opCode){
			var baseUrl = "${ctx}/data/student/dropoutList/";
...
<div class="dataGrid">	
<form action="${ctx}/data/student/dropoutList/queryList.action"   method="post" 
id="opForm" name="opForm">
	...
	<s:hidden name="bean.id" id="id" />
		<div class="filter" style="width: 100%;">
 		...
 		<table>
            <tbody >
             <tr>
                <th>班级名称 ：</th>
                <td><s:textfield name="bean.gradeid" cssClass="inputText"></s:textfield></td>
                
                 <th>学号 ：</th>
                <td><s:textfield name="bean.no" cssClass="inputText"></s:textfield></td>
                
                 <th>姓名 ：</th>
                <td><s:textfield name="bean.name" cssClass="inputText"></s:textfield></td>
                
                 <th>性别 ：</th>
                <td><s:textfield name="bean.sex" cssClass="inputText"></s:textfield></td>
                </tr>
                
                <tr>
                 <th>辍学原因：</th>
                <td><s:textfield name="bean.dropoutreson" cssClass="inputText"></s:textfield></td>
                
                 <th>辍学日期（年月）：</th>
                <td><s:textfield name="bean.dropoutdate" cssClass="inputText"></s:textfield></td>
		...
		<div class="tools" style="padding-top: 0px;">
			<ul class="toolbar">
