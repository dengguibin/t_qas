...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/student/dropoutList/save.action" method="post">
       ...
       <tr>
           ...
           <td><input type="text" class="inputText"  maxlength="50"  id="dropoutreson" name="bean.dropoutreson"  value="${bean.dropoutreson}"  /></td>
        </tr>
       <tr>
       	   <th width="120">辍学日期（年月）：</th>
           <td><input type="text" class="inputText"  maxlength="50"  id="dropoutdate" name="bean.dropoutdate"  value="${bean.dropoutdate}"  /></td>
        </tr>
       <%-- <tr>
       	   <th width="120">状态：</th>
          <td>
