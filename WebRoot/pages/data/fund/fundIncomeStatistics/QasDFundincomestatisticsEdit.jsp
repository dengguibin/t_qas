...
<div class="title"><span>当前位置：</span><x:menu menuId="${param.menuId}"/></div>
  <div class="editBlock">	
		<form id="opForm" name="opForm" onsubmit="return true;"
			action="${ctx}/data/fund/fundIncomeStatistics/save.action" method="post">
       ...
       <tr>
       	   <th width="120">学校总收入（万元）：</th>
          <td>
           <input type="text" class="inputText" id="schoolincome"  maxlength="9"  name="bean.schoolincome"  value="${bean.schoolincome}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">其中<-->学费收入<-->合计（万元）：</th>
          <td>
           <input type="text" class="inputText" id="tuitiontotal"  maxlength="9"  name="bean.tuitiontotal"  value="${bean.tuitiontotal}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">其中<-->财政经常性补助收入<-->合计（万元）：</th>
          <td>
           <input type="text" class="inputText" id="financialaidtotal"  maxlength="9"  name="bean.financialaidtotal"  value="${bean.financialaidtotal}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">其中<-->中央、地方财政专项投入<-->合计（万元）：</th>
          <td>
           <input type="text" class="inputText" id="specialinvestmenttotal"  maxlength="9"  name="bean.specialinvestmenttotal"  value="${bean.specialinvestmenttotal}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">其中<-->社会捐赠金额（万元）：</th>
          <td>
           <input type="text" class="inputText" id="socialdonation"  maxlength="9"  name="bean.socialdonation"  value="${bean.socialdonation}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">其中<-->其他收入总额（万元）：</th>
          <td>
           <input type="text" class="inputText" id="others"  maxlength="9"  name="bean.others"  value="${bean.others}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">贷款金额（万元）：</th>
          <td>
           <input type="text" class="inputText" id="loanamount"  maxlength="9"  name="bean.loanamount"  value="${bean.loanamount}"  />
           </td>
        </tr>
       <tr>
       	   <th width="120">贷款余额（万元）：</th>
          <td>
           <input type="text" class="inputText" id="loanbalance"  maxlength="9"  name="bean.loanbalance"  value="${bean.loanbalance}"  />
           </td>
        </tr>
       <%-- <tr>
       	   <th width="120">状态：</th>
