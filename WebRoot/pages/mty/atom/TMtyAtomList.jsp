...
<div class="dataGrid">	
<form action="${ctx}/mty/atom/queryList.action"   method="post" 
		  ...
		  <table id="dataTable" class="list_table">
            <thead>
              <tr>
                ...
                <!-- <th width="12%" style="text-align:center">前面的标签片段</th>
                <th width="12%" style="text-align:center">后面的标签片段</th>
                <th width="12%" style="text-align:center">前面的Js片段</th>
                <th width="12%" style="text-align:center">后面的Js片段</th> -->
            ...
            <c:forEach items="${datas}" var="item"  varStatus="stat">
	            <tr>
	                ...
	                <td style="text-align:center">${stat.count }</td>
                   	<td style="text-align:center">${item.NAME_ATOM}</td>
                   	<%-- <td>${item.FRONT_HTML}</td>
                   	<td>${item.BACK_HTML}</td>
                   	<td>${item.FRONT_JS}</td>
                   	<td>${item.BACK_JS}</td> --%>
                   	<td>${item.REMARK}</td>
