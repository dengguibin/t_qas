...
<!--
		function  opreate(args,opCode){
			...
			if('delete' === opCode){
				...
				$.registerForm('opForm');
				baseUrl = "${ctx}/plat/common/tCommonConfig!list.action?bean.code=SMS&menuId=${menuId}"
...
<div class="dataGrid">
<s:form action="tCommonMessage!listShortMessages" namespace="/plat/common" method="post" 
...
<input type="hidden" name="menuId" value="${menuId}" id="menuId">
	 <div class="itab tabson">
		    ...
		    <li><a href="${ctx }/plat/common/tCommonMessage!listShortMessages.action?menuId=${menuId}"  class="selected">短信消息</a></li> 
...
<div class="filter" style="padding-top: 10px;">
	...
	<c:if test="${qx.add }">
		<div class="tools">
		<ul class="toolbar">
        <li class="click setting"  onclick="opreate('','config');">短信配置</li>
