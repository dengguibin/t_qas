...
<div class="editBlock">
<form  id="opForm" name="opForm" onsubmit="return true;" enctype="multipart/form-data" action="${ctx}/collector/saveRunTran.action" method="post">
<s:token></s:token>
           ...
           <td>
            <textarea  class="textinput2" readonly="readonly" > ${bean.logs}</textarea>
	  			 ...
	  			 <tr>
					...
					<input type="button" class="inputButton" onclick="$('#opForm').submit();" value=" 手动执行 " />
